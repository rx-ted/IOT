# 1 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c"
...
# 1 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c"
# 11 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c"
# 1 "board/board.h" 1
# 13 "board/board.h"
#define __BOARD_H__ 
...
# 12 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c" 2

# 1 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers/drv_usart.h" 1
# 12 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers/drv_usart.h"
...
# 14 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c" 2




#define LOG_TAG "drv.uart"
# 1 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers/drv_log.h" 1
# 18 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers/drv_log.h"
...
# 1 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\include/rtdbg.h" 1
# 31 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\include/rtdbg.h"
#define RT_DBG_H__ 
# 53 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\include/rtdbg.h"
#define DLOG(...) 
# 62 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\include/rtdbg.h"
#define DBG_ERROR 0
...
# 154 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\include/rtdbg.h"
...
# 28 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers/drv_log.h" 2
# 20 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c" 2
...
enum
{
    ...
    UART1_INDEX,
# 53 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c"
};
...
static struct ch32_uart_hw_config uart_hw_config[] =
{

    {
        ...
        ((uint32_t)0x00004000), ((uint32_t)0x00000004),

        ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0200), ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0800)), ((uint16_t)0x0400),


        0,
    },
# 147 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c"
};
...
# 207 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c"
};
...
static rt_err_t ch32_configure(struct rt_serial_device *serial, struct serial_configure *cfg)
{
    ...
    uart->Init.USART_HardwareFlowControl = ((uint16_t)0x0000);
    uart->Init.USART_Mode = ((uint16_t)0x0004)|((uint16_t)0x0008);

    switch (cfg->data_bits)
    {
    case 8:
        uart->Init.USART_WordLength = ((uint16_t)0x0000);
        break;
    case 9:
        uart->Init.USART_WordLength = ((uint16_t)0x1000);
        break;
    default:
        uart->Init.USART_WordLength = ((uint16_t)0x0000);
        break;
    ...
    {
    case 0:
        uart->Init.USART_StopBits = ((uint16_t)0x0000);
        break;
    case 1:
        uart->Init.USART_StopBits = ((uint16_t)0x2000);
        break;
    default:
        uart->Init.USART_StopBits = ((uint16_t)0x0000);
        break;
    ...
    {
    case 0:
        uart->Init.USART_Parity = ((uint16_t)0x0000);
        break;
    case 1:
        uart->Init.USART_Parity = ((uint16_t)0x0600);
        break;
    case 2:
        uart->Init.USART_Parity = ((uint16_t)0x0400);
        break;
    default:
        uart->Init.USART_Parity = ((uint16_t)0x0000);
        break;
    ...
    if(uart->config->Instance == ((USART_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x3800)))
    {
...
static rt_err_t ch32_control(struct rt_serial_device *serial, int cmd, void *arg)
{
    ...
    case 0x07:
        ...
        USART_ITConfig(uart->config->Instance,((uint16_t)0x0525),DISABLE);
        break;
    ...
    case 0x06:
        ...
        USART_ITConfig(uart->config->Instance, ((uint16_t)0x0525),ENABLE);
        break;
    }
    return 0;
}
...
static int ch32_putc(struct rt_serial_device *serial, char c)
{
    ...
    ;
    uart = (struct ch32_uart *)serial->parent.user_data;
    while (USART_GetFlagStatus(uart->config->Instance, ((uint16_t)0x0040)) == RESET);
...
static int ch32_getc(struct rt_serial_device *serial)
{
    ...
    uart = (struct ch32_uart *)serial->parent.user_data;
    ch = -1;
    if (USART_GetFlagStatus(uart->config->Instance, ((uint16_t)0x0020)) != RESET)
    {
...
static void uart_isr(struct rt_serial_device *serial)
{
    ...
    ;
    if (USART_GetITStatus(uart->config->Instance, ((uint16_t)0x0525)) != RESET)
    {
        rt_hw_serial_isr(serial, 0x01);
        USART_ClearITPendingBit(uart->config->Instance, ((uint16_t)0x0525));
    }
}
...
# 499 "D:\\Users\\rx-ted\\Desktop\\rt-thread\\bsp\\wch\\risc-v\\Libraries\\ch32_drivers\\drv_usart.c"
int rt_hw_usart_init(void)
{
