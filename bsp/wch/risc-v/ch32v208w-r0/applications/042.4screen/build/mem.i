...
#define MEM_ISUSED(_mem) (((rt_base_t)(((struct rt_small_mem_item *)(_mem))->pool_ptr)) & (~MEM_MASK))

#define MEM_POOL(_mem) ((struct rt_small_mem *)(((rt_base_t)(((struct rt_small_mem_item *)(_mem))->pool_ptr)) & (MEM_MASK)))

#define MEM_SIZE(_heap,_mem) (((struct rt_small_mem_item *)(_mem))->next - ((rt_ubase_t)(_mem) - (rt_ubase_t)((_heap)->heap_ptr)) - RT_ALIGN(sizeof(struct rt_small_mem_item), RT_ALIGN_SIZE))
...
static void plug_holes(struct rt_small_mem *m, struct rt_small_mem_item *mem)
{
    ...
    if (mem != nmem && !(((rt_base_t)(((struct rt_small_mem_item *)(nmem))->pool_ptr)) & (~0xfffffffe)) &&
    ...
    if (pmem != mem && !(((rt_base_t)(((struct rt_small_mem_item *)(pmem))->pool_ptr)) & (~0xfffffffe)))
    {
                     ...
                     rt_size_t size)
{
    ...
    small_mem = (struct rt_small_mem *)((((rt_ubase_t)begin_addr) + (8) - 1) & ~((8) - 1));
    start_addr = (rt_ubase_t)small_mem + sizeof(*small_mem);
    begin_align = ((((rt_ubase_t)start_addr) + (8) - 1) & ~((8) - 1));
    end_align = (((rt_ubase_t)begin_addr + size) & ~((8) - 1));


    if ((end_align > (2 * (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)))) &&
        ((end_align - 2 * (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1))) >= start_addr))
    {

        mem_size = end_align - begin_align - 2 * (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1));
    }
    else
    {
    ...
    mem->pool_ptr = ((((rt_base_t)(small_mem)) & 0xfffffffe) | 0x0);
    mem->next = small_mem->mem_size_aligned + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1));
    mem->prev = 0;
    ...
    small_mem->heap_end->pool_ptr = ((((rt_base_t)(small_mem)) & 0xfffffffe) | 0x1);
    small_mem->heap_end->next = small_mem->mem_size_aligned + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1));
    small_mem->heap_end->prev = small_mem->mem_size_aligned + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1));
...
void *rt_smem_alloc(rt_smem_t m, rt_size_t size)
{
         ...
         ptr = ((struct rt_small_mem_item *)&small_mem->heap_ptr[ptr])->next)
    {
        ...
        if ((!(((rt_base_t)(((struct rt_small_mem_item *)(mem))->pool_ptr)) & (~0xfffffffe))) && (mem->next - (ptr + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)))) >= size)
        {



            if (mem->next - (ptr + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1))) >=
                (size + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)) + (((12) + (8) - 1) & ~((8) - 1))))
            {
# 339 "../../../../../../src/mem.c"
                ptr2 = ptr + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)) + size;


                mem2 = (struct rt_small_mem_item *)&small_mem->heap_ptr[ptr2];
                mem2->pool_ptr = ((((rt_base_t)(small_mem)) & 0xfffffffe) | 0x0);
                mem2->next = mem->next;
                mem2->prev = ptr;
                ...
                if (mem2->next != small_mem->mem_size_aligned + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)))
                {
                    ((struct rt_small_mem_item *)&small_mem->heap_ptr[mem2->next])->prev = ptr2;
                }
                small_mem->parent.used += (size + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)));
            ...
            mem->pool_ptr = ((((rt_base_t)(small_mem)) & 0xfffffffe) | 0x1);
            ...
            if (mem == small_mem->lfree)
            {
                ...
                while ((((rt_base_t)(((struct rt_small_mem_item *)(small_mem->lfree))->pool_ptr)) & (~0xfffffffe)) && small_mem->lfree != small_mem->heap_end)
            ...
            return (rt_uint8_t *)mem + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1));
        }
    }
...
void *rt_smem_realloc(rt_smem_t m, void *rmem, rt_size_t newsize)
{
    ...
    mem = (struct rt_small_mem_item *)((rt_uint8_t *)rmem - (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)));


    ptr = (rt_uint8_t *)mem - small_mem->heap_ptr;
    size = mem->next - ptr - (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1));
    if (size == newsize)
    {
    ...
    if (newsize + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)) + 12 < size)
    {

        small_mem->parent.used -= (size - newsize);

        ptr2 = ptr + (((sizeof(struct rt_small_mem_item)) + (8) - 1) & ~((8) - 1)) + newsize;
        mem2 = (struct rt_small_mem_item *)&small_mem->heap_ptr[ptr2];
        mem2->pool_ptr = ((((rt_base_t)(small_mem)) & 0xfffffffe) | 0x0);
        mem2->next = mem->next;
        mem2->prev = ptr;
...
void rt_smem_free(void *rmem)
{
    ...
    small_mem = ((struct rt_small_mem *)(((rt_base_t)(((struct rt_small_mem_item *)(mem))->pool_ptr)) & (0xfffffffe)));
    ;
    ;
    ;
    ;
