# 1 "../../../../../../components/drivers/ipc/dataqueue.c"
...
# 1 "../../../../../../components/drivers/ipc/dataqueue.c"
# 12 "../../../../../../components/drivers/ipc/dataqueue.c"
...
# 13 "../../../../../../components/drivers/ipc/dataqueue.c" 2
...
# 14 "../../../../../../components/drivers/ipc/dataqueue.c" 2
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
# 31 "../../../../../../include/rthw.h"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 15 "../../../../../../components/drivers/ipc/dataqueue.c" 2
...
# 41 "../../../../../../components/drivers/ipc/dataqueue.c"
rt_err_t
...
;
# 89 "../../../../../../components/drivers/ipc/dataqueue.c"
rt_err_t rt_data_queue_push(struct rt_data_queue *queue,
                            const void *data_ptr,
                            rt_size_t data_size,
                            rt_int32_t timeout)
...
;
# 206 "../../../../../../components/drivers/ipc/dataqueue.c"
rt_err_t rt_data_queue_pop(struct rt_data_queue *queue,
                           const void **data_ptr,
                           rt_size_t *size,
                           rt_int32_t timeout)
...
;
# 329 "../../../../../../components/drivers/ipc/dataqueue.c"
rt_err_t rt_data_queue_peek(struct rt_data_queue *queue,
                            const void **data_ptr,
                            rt_size_t *size)
{
...
;
# 362 "../../../../../../components/drivers/ipc/dataqueue.c"
void rt_data_queue_reset(struct rt_data_queue *queue)
{
    rt_base_t level;
...
;
# 442 "../../../../../../components/drivers/ipc/dataqueue.c"
rt_err_t rt_data_queue_deinit(struct rt_data_queue *queue)
{
    rt_base_t level;
...
;
# 469 "../../../../../../components/drivers/ipc/dataqueue.c"
rt_uint16_t rt_data_queue_len(struct rt_data_queue *queue)
{
    rt_base_t level;
    rt_int16_t len;
