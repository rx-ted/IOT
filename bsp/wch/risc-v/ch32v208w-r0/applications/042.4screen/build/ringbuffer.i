# 1 "../../../../../../components/drivers/ipc/ringbuffer.c"
...
# 1 "../../../../../../components/drivers/ipc/ringbuffer.c"
# 15 "../../../../../../components/drivers/ipc/ringbuffer.c"
...
# 16 "../../../../../../components/drivers/ipc/ringbuffer.c" 2
...
# 17 "../../../../../../components/drivers/ipc/ringbuffer.c" 2
...
# 18 "../../../../../../components/drivers/ipc/ringbuffer.c" 2


# 19 "../../../../../../components/drivers/ipc/ringbuffer.c"
...
# 38 "../../../../../../components/drivers/ipc/ringbuffer.c"
                        ...
                        rt_int32_t size)
{
    ...
    rb->buffer_ptr = pool;
    rb->buffer_size = ((size) & ~((8) - 1));
}
;
# 64 "../../../../../../components/drivers/ipc/ringbuffer.c"
...
;
# 117 "../../../../../../components/drivers/ipc/ringbuffer.c"
...
;
# 178 "../../../../../../components/drivers/ipc/ringbuffer.c"
...
;
# 232 "../../../../../../components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_peek(struct rt_ringbuffer *rb, rt_uint8_t **ptr)
{
    rt_size_t size;
...
;
# 273 "../../../../../../components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_putchar(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
    ;
...
;
# 306 "../../../../../../components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_putchar_force(struct rt_ringbuffer *rb, const rt_uint8_t ch)
{
...
;
# 347 "../../../../../../components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_getchar(struct rt_ringbuffer *rb, rt_uint8_t *ch)
{
    ;
...
;
# 379 "../../../../../../components/drivers/ipc/ringbuffer.c"
rt_size_t rt_ringbuffer_data_len(struct rt_ringbuffer *rb)
{
...
;
# 426 "../../../../../../components/drivers/ipc/ringbuffer.c"
