# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
...
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_gpio.h" 2
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c" 2
...
# 35 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_DeInit(GPIO_TypeDef *GPIOx)
{
...
# 72 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_AFIODeInit(void)
{
    RCC_APB2PeriphResetCmd(((uint32_t)0x00000001), ENABLE);
    RCC_APB2PeriphResetCmd(((uint32_t)0x00000001), DISABLE);
}
# 88 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_InitTypeDef *GPIO_InitStruct)
{
...
# 110 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
...
# 183 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_StructInit(GPIO_InitTypeDef *GPIO_InitStruct)
{
...
# 200 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
uint8_t GPIO_ReadInputDataBit(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
    uint8_t bitstatus = 0x00;
# 211 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
...
# 232 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
uint16_t GPIO_ReadInputData(GPIO_TypeDef *GPIOx)
{
    uint16_t val;
# 245 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
    val = ( uint16_t )GPIOx->INDR;


return ( val );
}
# 262 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
uint8_t GPIO_ReadOutputDataBit(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
    uint8_t bitstatus = 0x00;
# 273 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
...
# 294 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
uint16_t GPIO_ReadOutputData(GPIO_TypeDef *GPIOx)
{
    uint16_t val;
# 307 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
    val = ( uint16_t )GPIOx->OUTDR;


    return ( val );
}
# 324 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_SetBits(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
...
# 347 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_ResetBits(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
...
# 372 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_WriteBit(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin, BitAction BitVal)
{
...
# 401 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_Write(GPIO_TypeDef *GPIOx, uint16_t PortVal)
{
...
# 424 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_PinLockConfig(GPIO_TypeDef *GPIOx, uint16_t GPIO_Pin)
{
    uint32_t tmp = 0x00010000;
# 435 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
    tmp |= GPIO_Pin;
    GPIOx->LCKR = tmp;
    GPIOx->LCKR = GPIO_Pin;
    GPIOx->LCKR = tmp;
...
# 456 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_EventOutputConfig(uint8_t GPIO_PortSource, uint8_t GPIO_PinSource)
{
    uint32_t tmpreg = 0x00;

    tmpreg = ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->ECR;
    tmpreg &= ((uint16_t)0xFF80);
    tmpreg |= (uint32_t)GPIO_PortSource << 0x04;
    tmpreg |= GPIO_PinSource;
    ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->ECR = tmpreg;
}
# 476 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_EventOutputCmd(FunctionalState NewState)
{
    if(NewState)
    {
        ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->ECR |= (1 << 7);
    }
    else
    {
        ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->ECR &= ~(1 << 7);
...
# 545 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_PinRemapConfig(uint32_t GPIO_Remap, FunctionalState NewState)
{
    ...
    {
        tmpreg = ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->PCFR2;
    }
    else
    {
        tmpreg = ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->PCFR1;
    ...
    else
    {
        if((GPIO_Remap & (((uint32_t)0x00200000) | ((uint32_t)0x00100000))) == (((uint32_t)0x00200000) | ((uint32_t)0x00100000)))
        {
            ...
            ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->PCFR1 &= ((uint32_t)0xF0FFFFFF);
        }
        else if((GPIO_Remap & ((uint32_t)0x00100000)) == ((uint32_t)0x00100000))
        {
            tmp1 = ((uint32_t)0x03) << tmpmask;
    ...
    if((GPIO_Remap & 0x80000000) == 0x80000000)
    {
        ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->PCFR2 = tmpreg;
    }
    else
    {
        ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->PCFR1 = tmpreg;
    }
}
# 634 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_EXTILineConfig(uint8_t GPIO_PortSource, uint8_t GPIO_PinSource)
{
    uint32_t tmp = 0x00;
# 645 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
...
# 661 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
void GPIO_ETH_MediaInterfaceConfig(uint32_t GPIO_ETH_MediaInterface)
{
    if(GPIO_ETH_MediaInterface)
    {
        ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->PCFR1 |= (1 << 23);
    }
    else
    {
        ((AFIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0000))->PCFR1 &= ~(1 << 23);
