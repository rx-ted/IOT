# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
...
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_can.h" 2
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c" 2
...
# 60 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_DeInit(CAN_TypeDef* CANx)
{
...
# 88 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_Init(CAN_TypeDef* CANx, CAN_InitTypeDef* CAN_InitStruct)
{
  uint8_t InitStatus = ((uint8_t)0x00);
  uint32_t wait_ack = 0x00000000;

  CANx->CTLR &= (~(uint32_t)((uint16_t)0x0002));
  CANx->CTLR |= ((uint16_t)0x0001) ;

  while (((CANx->STATR & ((uint16_t)0x0001)) != ((uint16_t)0x0001)) && (wait_ack != ((uint32_t)0x0000FFFF)))
  {
    wait_ack++;
  }

  if ((CANx->STATR & ((uint16_t)0x0001)) != ((uint16_t)0x0001))
  {
  ...
  else
  {
    ...
    {
      CANx->CTLR |= ((uint16_t)0x0080);
    }
    else
    {
      CANx->CTLR &= ~(uint32_t)((uint16_t)0x0080);
    }

    if (CAN_InitStruct->CAN_ABOM == ENABLE)
    {
      CANx->CTLR |= ((uint16_t)0x0040);
    }
    else
    {
      CANx->CTLR &= ~(uint32_t)((uint16_t)0x0040);
    }

    if (CAN_InitStruct->CAN_AWUM == ENABLE)
    {
      CANx->CTLR |= ((uint16_t)0x0020);
    }
    else
    {
      CANx->CTLR &= ~(uint32_t)((uint16_t)0x0020);
    }

    if (CAN_InitStruct->CAN_NART == ENABLE)
    {
      CANx->CTLR |= ((uint16_t)0x0010);
    }
    else
    {
      CANx->CTLR &= ~(uint32_t)((uint16_t)0x0010);
    }

    if (CAN_InitStruct->CAN_RFLM == ENABLE)
    {
      CANx->CTLR |= ((uint16_t)0x0008);
    }
    else
    {
      CANx->CTLR &= ~(uint32_t)((uint16_t)0x0008);
    }

    if (CAN_InitStruct->CAN_TXFP == ENABLE)
    {
      CANx->CTLR |= ((uint16_t)0x0004);
    }
    else
    {
      CANx->CTLR &= ~(uint32_t)((uint16_t)0x0004);
    }
    ...
    CANx->CTLR &= ~(uint32_t)((uint16_t)0x0001);
    wait_ack = 0;
...
# 198 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_FilterInit(CAN_FilterInitTypeDef* CAN_FilterInitStruct)
{
  uint32_t filter_number_bit_pos = 0;

  filter_number_bit_pos = ((uint32_t)1) << CAN_FilterInitStruct->CAN_FilterNumber;
  ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FCTLR |= ((uint32_t)0x00000001);
  ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FWR &= ~(uint32_t)filter_number_bit_pos;

  if (CAN_FilterInitStruct->CAN_FilterScale == ((uint8_t)0x00))
  {
    ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FSCFGR &= ~(uint32_t)filter_number_bit_pos;
  ...
  {
    ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FSCFGR |= filter_number_bit_pos;
...
# 244 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
  if (CAN_FilterInitStruct->CAN_FilterMode == ((uint8_t)0x00))
  {
    ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FMCFGR &= ~(uint32_t)filter_number_bit_pos;
  }
  else
  {
    ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FMCFGR |= (uint32_t)filter_number_bit_pos;
  ...
  {
    ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FAFIFOR &= ~(uint32_t)filter_number_bit_pos;
  }
  ...
  {
    ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FWR |= filter_number_bit_pos;
  }

  ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FCTLR &= ~((uint32_t)0x00000001);
}
# 281 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_StructInit(CAN_InitTypeDef* CAN_InitStruct)
{
...
# 305 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_SlaveStartBank(uint8_t CAN_BankNumber)
{
  ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FCTLR |= ((uint32_t)0x00000001);
  ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FCTLR &= (uint32_t)0xFFFFC0F1 ;
  ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FCTLR |= (uint32_t)(CAN_BankNumber)<<8;
  ((CAN_TypeDef *)((((uint32_t)0x40000000)) + 0x6400))->FCTLR &= ~((uint32_t)0x00000001);
}
# 323 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_DBGFreeze(CAN_TypeDef* CANx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    CANx->CTLR |= ((uint32_t)0x00010000);
  }
  else
  {
    CANx->CTLR &= ~((uint32_t)0x00010000);
...
# 345 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_TTComModeCmd(CAN_TypeDef* CANx, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
    ...
    CANx->sTxMailBox[0].TXMDTR |= ((uint32_t)((uint32_t)0x00000100));
    CANx->sTxMailBox[1].TXMDTR |= ((uint32_t)((uint32_t)0x00000100));
    CANx->sTxMailBox[2].TXMDTR |= ((uint32_t)((uint32_t)0x00000100));
  }
  else
  {
    CANx->CTLR &= (uint32_t)(~(uint32_t)((uint16_t)0x0080));
...
# 377 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_Transmit(CAN_TypeDef* CANx, CanTxMsg* TxMessage)
{
  uint8_t transmit_mailbox = 0;

  if ((CANx->TSTATR&((uint32_t)0x04000000)) == ((uint32_t)0x04000000))
  {
    transmit_mailbox = 0;
  }
  else if ((CANx->TSTATR&((uint32_t)0x08000000)) == ((uint32_t)0x08000000))
  {
    transmit_mailbox = 1;
  }
  else if ((CANx->TSTATR&((uint32_t)0x10000000)) == ((uint32_t)0x10000000))
  {
    transmit_mailbox = 2;
  }
  else
  ...
  {
    CANx->sTxMailBox[transmit_mailbox].TXMIR &= ((uint32_t)0x00000001);
...
# 444 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_TransmitStatus(CAN_TypeDef* CANx, uint8_t TransmitMailbox)
{
  uint32_t state = 0;
  ...
  {
    case (((uint8_t)0x00)):
      state = CANx->TSTATR & (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000));
      break;

    case (((uint8_t)0x01)):
      state = CANx->TSTATR & (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000));
      break;

    case (((uint8_t)0x02)):
      state = CANx->TSTATR & (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000));
      break;
  ...
  switch (state)
  {
   ...
   state = ((uint8_t)0x02);
     ...
     case (((uint32_t)0x00000001) | ((uint32_t)0x04000000)):
   state = ((uint8_t)0x00);
      break;

     case (((uint32_t)0x00000100) | ((uint32_t)0x08000000)):
   state = ((uint8_t)0x00);
      break;

     case (((uint32_t)0x00010000) | ((uint32_t)0x10000000)):
   state = ((uint8_t)0x00);
      break;

    case (((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x04000000)):
   state = ((uint8_t)0x01);
      break;

    case (((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x08000000)):
   state = ((uint8_t)0x01);
      break;

    case (((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x10000000)):
   state = ((uint8_t)0x01);
      break;
...
# 518 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_CancelTransmit(CAN_TypeDef* CANx, uint8_t Mailbox)
{
  switch (Mailbox)
  {
    case (((uint8_t)0x00)):
   CANx->TSTATR |= ((uint32_t)0x00000080);
      break;

    case (((uint8_t)0x01)):
   CANx->TSTATR |= ((uint32_t)0x00008000);
      break;

    case (((uint8_t)0x02)):
   CANx->TSTATR |= ((uint32_t)0x00800000);
      break;
...
# 553 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_Receive(CAN_TypeDef* CANx, uint8_t FIFONumber, CanRxMsg* RxMessage)
{
  ...
  {
    CANx->RFIFO0 |= ((uint8_t)0x20);
  }
  else
  {
    CANx->RFIFO1 |= ((uint8_t)0x20);
  }
}
# 600 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_FIFORelease(CAN_TypeDef* CANx, uint8_t FIFONumber)
{
  if (FIFONumber == ((uint8_t)0x00))
  {
...
# 624 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_MessagePending(CAN_TypeDef* CANx, uint8_t FIFONumber)
{
...
# 659 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_OperatingModeRequest(CAN_TypeDef* CANx, uint8_t CAN_OperatingMode)
{
  ...
  {
    CANx->CTLR = (uint32_t)((CANx->CTLR & (uint32_t)(~(uint32_t)((uint16_t)0x0002))) | ((uint16_t)0x0001));

    while (((CANx->STATR & ((uint32_t) 0x00000003)) != ((uint16_t)0x0001)) && (timeout != 0))
    {
      timeout--;
    }
    if ((CANx->STATR & ((uint32_t) 0x00000003)) != ((uint16_t)0x0001))
    {
      status = ((uint8_t)0x00);
    }
    else
  ...
  {
    CANx->CTLR &= (uint32_t)(~(((uint16_t)0x0002)|((uint16_t)0x0001)));

    while (((CANx->STATR & ((uint32_t) 0x00000003)) != 0) && (timeout!=0))
    {
      timeout--;
    }
    if ((CANx->STATR & ((uint32_t) 0x00000003)) != 0)
    {
      status = ((uint8_t)0x00);
    }
    else
  ...
  {
    CANx->CTLR = (uint32_t)((CANx->CTLR & (uint32_t)(~(uint32_t)((uint16_t)0x0001))) | ((uint16_t)0x0002));

    while (((CANx->STATR & ((uint32_t) 0x00000003)) != ((uint16_t)0x0002)) && (timeout!=0))
    {
      timeout--;
    }
    if ((CANx->STATR & ((uint32_t) 0x00000003)) != ((uint16_t)0x0002))
    {
      status = ((uint8_t)0x00);
    }
    else
...
# 734 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_Sleep(CAN_TypeDef* CANx)
{
  uint8_t sleepstatus = ((uint8_t)0x00);

  CANx->CTLR = (((CANx->CTLR) & (uint32_t)(~(uint32_t)((uint16_t)0x0001))) | ((uint16_t)0x0002));

  if ((CANx->STATR & (((uint16_t)0x0002)|((uint16_t)0x0001))) == ((uint16_t)0x0002))
  {
...
# 759 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_WakeUp(CAN_TypeDef* CANx)
{
  ...
  while(((CANx->STATR & ((uint16_t)0x0002)) == ((uint16_t)0x0002))&&(wait_slak!=0x00))
  {
   wait_slak--;
  }
  if((CANx->STATR & ((uint16_t)0x0002)) != ((uint16_t)0x0002))
  {
...
# 795 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_GetLastErrorCode(CAN_TypeDef* CANx)
{
  uint8_t errorcode=0;

  errorcode = (((uint8_t)CANx->ERRSR) & (uint8_t)((uint32_t)0x00000070));

  return errorcode;
}
# 813 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_GetReceiveErrorCounter(CAN_TypeDef* CANx)
{
  uint8_t counter=0;

  counter = (uint8_t)((CANx->ERRSR & ((uint32_t)0xFF000000))>> 24);

  return counter;
}
# 831 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
uint8_t CAN_GetLSBTransmitErrorCounter(CAN_TypeDef* CANx)
{
  uint8_t counter=0;

  counter = (uint8_t)((CANx->ERRSR & ((uint32_t)0x00FF0000))>> 16);

  return counter;
}
# 864 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_ITConfig(CAN_TypeDef* CANx, uint32_t CAN_IT, FunctionalState NewState)
{
  if (NewState != DISABLE)
  {
...
# 902 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
FlagStatus CAN_GetFlagStatus(CAN_TypeDef* CANx, uint32_t CAN_FLAG)
{
...
# 985 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_ClearFlag(CAN_TypeDef* CANx, uint32_t CAN_FLAG)
{
  uint32_t flagtmp=0;
...
# 1040 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
ITStatus CAN_GetITStatus(CAN_TypeDef* CANx, uint32_t CAN_IT)
{
  ...
  if((CANx->INTENR & CAN_IT) != RESET)
  {
    switch (CAN_IT)
    {
      case ((uint32_t)0x00000001):
       itstatus = CheckITStatus(CANx->TSTATR, ((uint32_t)0x00000001)|((uint32_t)0x00000100)|((uint32_t)0x00010000));
       break;

      case ((uint32_t)0x00000002):
     itstatus = CheckITStatus(CANx->RFIFO0, ((uint8_t)0x03));
       break;

      case ((uint32_t)0x00000004):
        itstatus = CheckITStatus(CANx->RFIFO0, ((uint8_t)0x08));
       break;

      case ((uint32_t)0x00000008):
        itstatus = CheckITStatus(CANx->RFIFO0, ((uint8_t)0x10));
       break;

      case ((uint32_t)0x00000010):
        itstatus = CheckITStatus(CANx->RFIFO1, ((uint8_t)0x03));
       break;

      case ((uint32_t)0x00000020):
       itstatus = CheckITStatus(CANx->RFIFO1, ((uint8_t)0x08));
       break;

      case ((uint32_t)0x00000040):
       itstatus = CheckITStatus(CANx->RFIFO1, ((uint8_t)0x10));
       break;

      case ((uint32_t)0x00010000):
        itstatus = CheckITStatus(CANx->STATR, ((uint16_t)0x0008));
       break;

      case ((uint32_t)0x00020000):
       itstatus = CheckITStatus(CANx->STATR, ((uint16_t)0x0010));
       break;

      case ((uint32_t)0x00000100):
       itstatus = CheckITStatus(CANx->ERRSR, ((uint32_t)0x00000001));
       break;

      case ((uint32_t)0x00000200):
       itstatus = CheckITStatus(CANx->ERRSR, ((uint32_t)0x00000002));
       break;

      case ((uint32_t)0x00000400):
       itstatus = CheckITStatus(CANx->ERRSR, ((uint32_t)0x00000004));
       break;

      case ((uint32_t)0x00000800):
       itstatus = CheckITStatus(CANx->ERRSR, ((uint32_t)0x00000070));
       break;

      case ((uint32_t)0x00008000):
        itstatus = CheckITStatus(CANx->STATR, ((uint16_t)0x0004));
       break;
...
# 1139 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
void CAN_ClearITPendingBit(CAN_TypeDef* CANx, uint32_t CAN_IT)
{
 switch (CAN_IT)
 {
  case ((uint32_t)0x00000001):
   CANx->TSTATR = ((uint32_t)0x00000001)|((uint32_t)0x00000100)|((uint32_t)0x00010000);
   break;

  case ((uint32_t)0x00000004):
   CANx->RFIFO0 = ((uint8_t)0x08);
   break;

  case ((uint32_t)0x00000008):
   CANx->RFIFO0 = ((uint8_t)0x10);
   break;

  case ((uint32_t)0x00000020):
   CANx->RFIFO1 = ((uint8_t)0x08);
   break;

  case ((uint32_t)0x00000040):
   CANx->RFIFO1 = ((uint8_t)0x10);
   break;

  case ((uint32_t)0x00010000):
   CANx->STATR = ((uint16_t)0x0008);
   break;

  case ((uint32_t)0x00020000):
   CANx->STATR = ((uint16_t)0x0010);
   break;

  case ((uint32_t)0x00000100):
   CANx->STATR = ((uint16_t)0x0004);
   break;
...
# 1208 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_can.c"
static ITStatus CheckITStatus(uint32_t CAN_Reg, uint32_t It_Bit)
{
