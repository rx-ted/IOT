# 1 "../../../../../../components/drivers/misc/rt_drv_pwm.c"
...
# 1 "../../../../../../components/drivers/misc/rt_drv_pwm.c"
# 15 "../../../../../../components/drivers/misc/rt_drv_pwm.c"
...
# 16 "../../../../../../components/drivers/include/rtdevice.h" 2
...
# 1 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\_ansi.h" 1 3
# 11 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\time.h" 2 3
...
# 13 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\time.h" 2 3
...
# 16 "../../../../../../components/drivers/misc/rt_drv_pwm.c" 2
...
static rt_err_t _pwm_control(rt_device_t dev, int cmd, void *args)
{
    ...
    switch (cmd)
    {
        case (((RT_Device_Class_PWM + 1) * 0x100) + 4):
            configuration->complementary = 1;
            break;
        case (((RT_Device_Class_PWM + 1) * 0x100) + 5):
            configuration->complementary = 0;
            break;
        default:
            if(pwm->ops->control)
...
static rt_ssize_t _pwm_read(rt_device_t dev, rt_off_t pos, void *buffer, rt_size_t size)
{
    ...
    if (pwm->ops->control)
    {
        result = pwm->ops->control(pwm, (((RT_Device_Class_PWM + 1) * 0x100) + 3), &configuration);
        if (result != 0)
        {
            return 0;
        }
...
static rt_ssize_t _pwm_write(rt_device_t dev, rt_off_t pos, const void *buffer, rt_size_t size)
{
    ...
    if (pwm->ops->control)
    {
        ...
        result = pwm->ops->control(pwm, (((RT_Device_Class_PWM + 1) * 0x100) + 2), &configuration);
        if (result != 0)
        {
            return 0;
        }
...
# 115 "../../../../../../components/drivers/misc/rt_drv_pwm.c"
rt_err_t rt_device_pwm_register(struct rt_device_pwm *device, const char *name, const struct rt_pwm_ops *ops, const void *user_data)
{
    rt_err_t result = 0;
...
rt_err_t rt_pwm_enable(struct rt_device_pwm *device, int channel)
{
    ...
    if(channel > 0)
    {
        result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 5), &configuration);
    }
    else
    {
        result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 4), &configuration);
    }

    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 0), &configuration);
...
rt_err_t rt_pwm_disable(struct rt_device_pwm *device, int channel)
{
    ...
    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 1), &configuration);
...
rt_err_t rt_pwm_set(struct rt_device_pwm *device, int channel, rt_uint32_t period, rt_uint32_t pulse)
{
    ...
    configuration.pulse = pulse;
    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 2), &configuration);
...
rt_err_t rt_pwm_set_period(struct rt_device_pwm *device, int channel, rt_uint32_t period)
{
    ...
    configuration.channel = (channel > 0) ? (channel) : (-channel);
    configuration.period = period;
    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 6), &configuration);
...
rt_err_t rt_pwm_set_pulse(struct rt_device_pwm *device, int channel, rt_uint32_t pulse)
{
    ...
    configuration.channel = (channel > 0) ? (channel) : (-channel);
    configuration.pulse = pulse;
    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 7), &configuration);
...
rt_err_t rt_pwm_set_dead_time(struct rt_device_pwm *device, int channel, rt_uint32_t dead_time)
{
    ...
    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 8), &configuration);
...
rt_err_t rt_pwm_set_phase(struct rt_device_pwm *device, int channel, rt_uint32_t phase)
{
    ...
    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 9), &configuration);
...
rt_err_t rt_pwm_get(struct rt_device_pwm *device, struct rt_pwm_configuration *cfg)
{
    ...
    result = rt_device_control(&device->parent, (((RT_Device_Class_PWM + 1) * 0x100) + 3), cfg);

    return result;
}


# 1 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 1 3
...
# 1 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\machine\\ieeefp.h" 1 3
# 11 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 2 3
...
#define offsetof(TYPE,MEMBER) __builtin_offsetof (TYPE, MEMBER)
# 17 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 2 3



# 1 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\machine\\stdlib.h" 1 3

#define _MACHSTDLIB_H_ 
# 21 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 2 3

# 1 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\alloca.h" 1 3
...
# 23 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 2 3
# 33 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3



# 35 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
typedef struct
{
  int quot;
  int rem;
...
# 133 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
...
# 155 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
...
# 187 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
int system (const char *__string);
# 198 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
...
# 220 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
...
# 259 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
...
# 280 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
...
# 317 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h" 3
...
# 301 "../../../../../../components/drivers/misc/rt_drv_pwm.c" 2
...
# 302 "../../../../../../components/drivers/misc/rt_drv_pwm.c" 2



# 304 "../../../../../../components/drivers/misc/rt_drv_pwm.c"
static int pwm(int argc, char **argv)
{
    rt_err_t result = -1;
    char *result_str;
    static struct rt_device_pwm *pwm_device = 0;
    ...
    if(argc > 1)
    {
        if(!strcmp(argv[1], "probe"))
        {
            if(argc == 3)
            {
                ...
                result_str = (pwm_device == 0) ? "failure" : "success";
        ...
        else
        {
            ...
            if(!strcmp(argv[1], "enable"))
            {
                if(argc == 3)
                {
                    ...
                    result_str = (result == 0) ? "success" : "failure";
...
const char __fsym_pwm_name[] __attribute__((section(".rodata.name"))) = "pwm"; const char __fsym_pwm_desc[] __attribute__((section(".rodata.name"))) = "pwm [option]"; __attribute__((used)) const struct finsh_syscall __fsym_pwm __attribute__((section("FSymTab")))= { __fsym_pwm_name, __fsym_pwm_desc, (syscall_func)&pwm };;
