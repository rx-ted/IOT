...
EXTI_DeInit:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
	.loc 1 24 1
	.cfi_startproc
	.loc 1 25 5
	.loc 1 25 77 is_stmt 0
	li	a4,1073807360
	addi	a5,a4,1024
	sw	zero,1024(a4)
	.loc 1 26 5 is_stmt 1
	.loc 1 26 76 is_stmt 0
	sw	zero,1028(a4)
	.loc 1 27 5 is_stmt 1
	.loc 1 27 76 is_stmt 0
	sw	zero,1032(a4)
	.loc 1 28 5 is_stmt 1
	.loc 1 28 76 is_stmt 0
	sw	zero,1036(a4)
	.loc 1 29 5 is_stmt 1
	.loc 1 29 76 is_stmt 0
	li	a4,1048576
	addi	a4,a4,-1
	sw	a4,20(a5)
	.loc 1 30 1
...
.LVL8:
	.loc 1 85 5
	.loc 1 85 32 is_stmt 0
	sw	zero,0(a0)
	.loc 1 86 5 is_stmt 1
	.loc 1 86 32 is_stmt 0
	sw	zero,4(a0)
	.loc 1 87 5 is_stmt 1
	.loc 1 87 35 is_stmt 0
	li	a5,12
	sw	a5,8(a0)
...
.Letext0:
	...
	.file 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_exti.h"
...
.Ldebug_macro46:
	...
	.4byte	.LASF5167
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.ch32v20x_exti.h.52.98852d78204427beb42aed3091b4213a,comdat
.Ldebug_macro47:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF4942:
	.string	"_T_PTRDIFF_ "
.LASF5346:
	.string	"EXTI_GenerateSWInterrupt"
.LASF130:
...
.LASF5190:
	.string	"EXTI_LINENONE ((uint32_t)0x00000)"
.LASF789:
...
.LASF5351:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
.LASF2989:
