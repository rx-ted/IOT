...
.LVL1:
	...
	beq	a1,a5,.L2
	.loc 1 135 75 discriminator 1
	lw	a4,0(a5)
	.loc 1 135 88 discriminator 1
	andi	a4,a4,1
	.loc 1 135 21 discriminator 1
	bnez	a4,.L2
	.loc 1 136 46 discriminator 2
	lw	a4,44(a0)
	.loc 1 135 105 discriminator 2
	beq	a4,a5,.L2
...
.LVL3:
	...
	beq	a1,a5,.L1
	.loc 1 152 75 discriminator 1
	lw	a4,0(a5)
	.loc 1 152 88 discriminator 1
	andi	a4,a4,1
...
.LFE15:
	...
	.section	.text.rt_smem_init,"ax",@progbits
	.align	1
	.globl	rt_smem_init
	.type	rt_smem_init, @function
rt_smem_init:
.LFB16:
...
.LVL19:
	...
	.loc 1 229 78 is_stmt 0
	ori	a4,s0,1
	.loc 1 229 35
	sw	a4,0(a5)
	.loc 1 230 5 is_stmt 1
	.loc 1 230 42 is_stmt 0
	lw	a5,52(s0)
	.loc 1 230 14
	lw	a4,44(s0)
	.loc 1 230 61
...
.LVL23:
	...
	.cfi_endproc
.LFE16:
	.size	rt_smem_init, .-rt_smem_init
	.section	.text.rt_smem_detach,"ax",@progbits
	.align	1
	.globl	rt_smem_detach
	.type	rt_smem_detach, @function
rt_smem_detach:
.LFB17:
...
.LVL25:
	...
	.cfi_endproc
.LFE17:
	.size	rt_smem_detach, .-rt_smem_detach
	.section	.text.rt_smem_alloc,"ax",@progbits
	.align	1
	.globl	rt_smem_alloc
	.type	rt_smem_alloc, @function
rt_smem_alloc:
.LFB18:
...
.LVL32:
	...
	j	.L21
.L24:
	.loc 1 387 21 is_stmt 1
	.loc 1 387 78 is_stmt 0
	lw	a5,40(a0)
	.loc 1 387 105
	lw	a3,4(a3)
	.loc 1 387 68
...
.L22:
	...
	.loc 1 386 23
	beqz	a5,.L23
	.loc 1 386 148 discriminator 1
	lw	a5,44(a0)
	.loc 1 386 116 discriminator 1
	bne	a3,a5,.L24
	j	.L23
.LVL33:
.L18:
...
.LVL35:
	...
	.loc 1 321 64 is_stmt 0
	lw	a5,0(a4)
	.loc 1 321 77
	andi	a5,a5,1
	.loc 1 321 12
	bnez	a5,.L18
	.loc 1 321 102 discriminator 1
	lw	a7,4(a4)
	.loc 1 321 109 discriminator 1
	sub	a5,a7,a3
	addi	a5,a5,-16
	.loc 1 321 95 discriminator 1
	bltu	a5,a1,.L18
	.loc 1 326 13 is_stmt 1
	.loc 1 327 87 is_stmt 0
	addi	a6,a1,32
	.loc 1 326 16
	bltu	a5,a6,.L19
	.loc 1 339 17 is_stmt 1
	.loc 1 339 92 is_stmt 0
	add	a5,a1,a3
	.loc 1 339 22
	addi	a5,a5,16
.LVL36:
	...
	add	a2,a2,a5
.LVL37:
	.loc 1 343 17 is_stmt 1
	.loc 1 343 75 is_stmt 0
	andi	a6,a0,-2
	.loc 1 343 32
	sw	a6,0(a2)
...
.LVL40:
	...
	.loc 1 359 43 is_stmt 0
	sw	a5,36(a0)
.L21:
	.loc 1 375 13 is_stmt 1
	.loc 1 375 70 is_stmt 0
	ori	a5,a0,1
	.loc 1 375 27
	sw	a5,0(a4)
...
.LVL47:
	...
	.cfi_endproc
.LFE18:
	.size	rt_smem_alloc, .-rt_smem_alloc
	.section	.text.rt_smem_free,"ax",@progbits
	.align	1
	.globl	rt_smem_free
	.type	rt_smem_free, @function
rt_smem_free:
.LFB20:
...
.L34:
	...
	.cfi_endproc
.LFE20:
	.size	rt_smem_free, .-rt_smem_free
	.section	.text.rt_smem_realloc,"ax",@progbits
	.align	1
	.globl	rt_smem_realloc
	.type	rt_smem_realloc, @function
rt_smem_realloc:
.LFB19:
...
.L46:
	...
	.cfi_endproc
.LFE19:
	.size	rt_smem_realloc, .-rt_smem_realloc
	.section	.rodata.rt_smem_init.str1.4,"aMS",@progbits,1
	.align	2
.LC0:
	.string	"small"
	.zero	2
...
.LASF1075:
	.string	"MIN_SIZE_ALIGNED RT_ALIGN(MIN_SIZE, RT_ALIGN_SIZE)"
.LASF187:
...
.LASF1071:
	.string	"MEM_FREED() ((((rt_base_t)(small_mem)) & MEM_MASK) | 0x0)"
.LASF590:
...
.LASF1076:
	.string	"SIZEOF_STRUCT_MEM RT_ALIGN(sizeof(struct rt_small_mem_item), RT_ALIGN_SIZE)"
.LASF1016:
...
.LASF1072:
	.string	"MEM_ISUSED(_mem) (((rt_base_t)(((struct rt_small_mem_item *)(_mem))->pool_ptr)) & (~MEM_MASK))"
.LASF242:
...
.LASF1073:
	.string	"MEM_POOL(_mem) ((struct rt_small_mem *)(((rt_base_t)(((struct rt_small_mem_item *)(_mem))->pool_ptr)) & (MEM_MASK)))"
.LASF24:
...
.LASF795:
	.string	"unsigned"
.LASF1070:
	.string	"MEM_USED() ((((rt_base_t)(small_mem)) & MEM_MASK) | 0x1)"
.LASF367:
...
.LASF1074:
	.string	"MEM_SIZE(_heap,_mem) (((struct rt_small_mem_item *)(_mem))->next - ((rt_ubase_t)(_mem) - (rt_ubase_t)((_heap)->heap_ptr)) - RT_ALIGN(sizeof(struct rt_small_mem_item), RT_ALIGN_SIZE))"
.LASF1052:
