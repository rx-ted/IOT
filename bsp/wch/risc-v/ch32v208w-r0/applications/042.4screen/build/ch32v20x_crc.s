...
CRC_ResetDR:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
	.loc 1 20 1
	.cfi_startproc
	.loc 1 21 5
	.loc 1 21 74 is_stmt 0
	li	a5,1073885184
	li	a4,1
	sw	a4,8(a5)
	.loc 1 22 1
...
.LVL0:
	.loc 1 35 5
	.loc 1 35 75 is_stmt 0
	li	a5,1073885184
	sw	a0,0(a5)
	.loc 1 37 5 is_stmt 1
	.loc 1 37 75 is_stmt 0
	lw	a0,0(a5)
.LVL1:
	.loc 1 38 1
	ret
...
.L4:
	...
	.loc 1 55 88 is_stmt 0 discriminator 3
	slli	a4,a5,2
	add	a4,a0,a4
	lw	a3,0(a4)
	.loc 1 55 79 discriminator 3
	li	a4,1073885184
	sw	a3,0(a4)
	.loc 1 54 47 discriminator 3
	addi	a5,a5,1
.LVL4:
	j	.L4
.L6:
	.loc 1 58 5 is_stmt 1
	.loc 1 58 75 is_stmt 0
	li	a5,1073885184
.LVL5:
	lw	a0,0(a5)
.LVL6:
...
.Ldebug_macro0:
	...
	.byte	0x7
	.4byte	.LASF319
	.file 9 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_crc.h"
	.byte	0x3
	.byte	0xa
	.byte	0x9
	.byte	0x5
	...
	.4byte	.Ldebug_macro3
	.byte	0x4
	.file 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/include/core_riscv.h"
	.byte	0x3
	.byte	0x86,0x1
	.byte	0xa
	.byte	0x7
...
.LASF5331:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
.LASF4400:
