# 1 "../../../../../../components/drivers/hwtimer/hwtimer.c"
...
# 1 "../../../../../../components/drivers/hwtimer/hwtimer.c"
# 11 "../../../../../../components/drivers/hwtimer/hwtimer.c"
...
# 12 "../../../../../../components/drivers/hwtimer/hwtimer.c" 2
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
# 31 "../../../../../../include/rthw.h"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 13 "../../../../../../components/drivers/hwtimer/hwtimer.c" 2
...
# 17 "../../../../../../components/drivers/hwtimer/hwtimer.c" 2

static __inline rt_uint32_t timeout_calc(rt_hwtimer_t *timer, rt_hwtimerval_t *tv)
{
    float overflow;
    float timeout;
    rt_uint32_t counter;
...
static rt_ssize_t rt_hwtimer_write(struct rt_device *dev, rt_off_t pos, const void *buffer, rt_size_t size)
{
    ...
    timer = (rt_hwtimer_t *)dev;
    if ((timer->ops->start == 0) || (timer->ops->stop == 0))
        return 0;
    ...
    if (timer->ops->start(timer, t, opm) != 0)
        size = 0;
...
# 361 "../../../../../../components/drivers/hwtimer/hwtimer.c"
rt_err_t rt_device_hwtimer_register(rt_hwtimer_t *timer, const char *name, void *user_data)
{
    ...
    return rt_device_register(device, name, 0x003 | 0x008);
}
