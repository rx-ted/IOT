# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
...
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_crc.h" 2
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c" 2
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
void CRC_ResetDR(void)
{
    ((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->CTLR = ((uint8_t)0x01);
}
# 33 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
uint32_t CRC_CalcCRC(uint32_t Data)
{
    ((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->DATAR = Data;

    return (((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->DATAR);
}
# 50 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
uint32_t CRC_CalcBlockCRC(uint32_t pBuffer[], uint32_t BufferLength)
{
    uint32_t index = 0;

    for(index = 0; index < BufferLength; index++){
        ((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->DATAR = pBuffer[index];
    }

    return (((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->DATAR);
}
# 68 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
uint32_t CRC_GetCRC(void)
{
    return (((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->DATAR);
}
# 82 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
void CRC_SetIDRegister(uint8_t IDValue)
{
    ((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->IDATAR = IDValue;
}
# 94 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_crc.c"
uint8_t CRC_GetIDRegister(void)
{
    return (((CRC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x3000))->IDATAR);
}
