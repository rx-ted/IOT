...
# 24 "../../../../../../components/finsh/shell.c" 2



# 1 "../../../../../../components/finsh/shell.h" 1
# 12 "../../../../../../components/finsh/shell.h"
#define __SHELL_H__ 


# 1 "../../../../../../components/finsh/finsh.h" 1
# 16 "../../../../../../components/finsh/shell.h" 2
# 27 "../../../../../../components/finsh/shell.h"
#define FINSH_OPTION_ECHO 0x01

#define FINSH_PROMPT finsh_get_prompt()

# 30 "../../../../../../components/finsh/shell.h"
const char *finsh_get_prompt(void);
int finsh_set_prompt(const char *prompt);
# 55 "../../../../../../components/finsh/shell.h"
enum input_stat
{
    WAIT_NORMAL,
    WAIT_SPEC_KEY,
...
# 28 "../../../../../../components/finsh/shell.c" 2
# 1 "../../../../../../components/finsh/msh.h" 1
# 12 "../../../../../../components/finsh/msh.h"
#define __M_SHELL__ 
...
# 29 "../../../../../../components/finsh/shell.c" 2
# 45 "../../../../../../components/finsh/shell.c"
    struct finsh_syscall *_syscall_table_begin = 
# 45 "../../../../../../components/finsh/shell.c" 3
                                                 ((void *)0)
# 45 "../../../../../../components/finsh/shell.c"
                                                     ;
    struct finsh_syscall *_syscall_table_end = 
# 46 "../../../../../../components/finsh/shell.c" 3
                                                 ((void *)0)
# 46 "../../../../../../components/finsh/shell.c"
                                                     ;


struct finsh_shell *shell;
static char *finsh_prompt_custom = 0;
# 66 "../../../../../../components/finsh/shell.c"
int finsh_set_prompt(const char *prompt)
{
    if (finsh_prompt_custom)
    {
        rt_free(finsh_prompt_custom);
        finsh_prompt_custom = 0;
    }
...
const char *finsh_get_prompt(void)
{
    static char finsh_prompt[128 + 1] = {0};
...
# 127 "../../../../../../components/finsh/shell.c"
rt_uint32_t finsh_get_prompt_mode(void)
{
    ;
    return shell->prompt_mode;
}
# 142 "../../../../../../components/finsh/shell.c"
void finsh_set_prompt_mode(rt_uint32_t prompt_mode)
{
    ;
...
void finsh_set_device(const char *device_name)
{
    ...
    if (rt_device_open(dev, 0x003 | 0x100 |
                       0x040) == 0)
    {
        if (shell->device != 0)
        {
            ...
            rt_device_set_rx_indicate(shell->device, 0);
        }
...
# 251 "../../../../../../components/finsh/shell.c"
const char *finsh_get_device()
{
    ;
    return shell->device->parent.name;
}
# 267 "../../../../../../components/finsh/shell.c"
void finsh_set_echo(rt_uint32_t echo)
{
    ;
    shell->echo_mode = (rt_uint8_t)echo;
}
# 280 "../../../../../../components/finsh/shell.c"
...
# 379 "../../../../../../components/finsh/shell.c"
static void shell_auto_complete(char *prefix)
{
    rt_kprintf("\n");
    msh_auto_complete(prefix);

    rt_kprintf("%s%s", finsh_get_prompt(), prefix);
}


static rt_bool_t shell_handle_history(struct finsh_shell *shell)
{
# 399 "../../../../../../components/finsh/shell.c"
    rt_kprintf("\033[2K\r");

    rt_kprintf("%s%s", finsh_get_prompt(), shell->line);
    return 0;
}
...
static void shell_push_history(struct finsh_shell *shell)
{
    if (shell->line_position != 0)
    {
        ...
        if (shell->history_count >= 5)
        {
            ...
            if (memcmp(&shell->cmd_history[5 - 1], shell->line, 80))
            {
                ...
                for (index = 0; index < 5 - 1; index ++)
                {
                    rt_memcpy(&shell->cmd_history[index][0],
                           &shell->cmd_history[index + 1][0], 80);
                }
                rt_memset(&shell->cmd_history[index][0], 0, 80);
        ...
        else
        {
            ...
            if (shell->history_count == 0 || memcmp(&shell->cmd_history[shell->history_count - 1], shell->line, 80))
            {
                shell->current_history = shell->history_count;
                rt_memset(&shell->cmd_history[shell->history_count][0], 0, 80);
...
# 483 "../../../../../../components/finsh/shell.c"
    rt_kprintf(finsh_get_prompt());
...
# 731 "../../../../../../components/finsh/shell.c"
int finsh_system_init(void)
{
    rt_err_t result = 0;
    rt_thread_t tid;
# 746 "../../../../../../components/finsh/shell.c"
    extern const int __fsymtab_start;
    extern const int __fsymtab_end;
    finsh_system_function_init(&__fsymtab_start, &__fsymtab_end);
# 774 "../../../../../../components/finsh/shell.c"
    ...
    tid = rt_thread_create("tshell",
                           ...
                           2048, 20, 10);
# 793 "../../../../../../components/finsh/shell.c"
    rt_sem_init(&(shell->rx_sem), "shrx", 0, 0);
    finsh_set_prompt_mode(1);

    if (tid != 
# 796 "../../../../../../components/finsh/shell.c" 3
              ((void *)0) 
# 796 "../../../../../../components/finsh/shell.c"
                   && result == 0)
