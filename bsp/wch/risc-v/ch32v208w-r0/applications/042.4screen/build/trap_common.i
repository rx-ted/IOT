# 1 "../../../../../../libcpu/risc-v/common/trap_common.c"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 2 "../../../../../../libcpu/risc-v/common/trap_common.c" 2

# 1 "../../../../../../libcpu/risc-v/common/riscv-ops.h" 1
# 12 "../../../../../../libcpu/risc-v/common/riscv-ops.h"
...
# 4 "../../../../../../libcpu/risc-v/common/trap_common.c" 2
# 1 "../../../../../../libcpu/risc-v/common/rt_hw_stack_frame.h" 1
# 12 "../../../../../../libcpu/risc-v/common/rt_hw_stack_frame.h"
#define RISCV_STACKFRAME_H 

# 1 "../../../../../../libcpu/risc-v/common/cpuport.h" 1
# 14 "../../../../../../libcpu/risc-v/common/cpuport.h"
#define CPUPORT_H__ 
# 45 "../../../../../../libcpu/risc-v/common/cpuport.h"
#define STORE sw
#define LOAD lw
#define REGBYTES 4
# 15 "../../../../../../libcpu/risc-v/common/rt_hw_stack_frame.h" 2
...
typedef struct rt_hw_stack_frame
{
    ...
    rt_ubase_t t5;
    rt_ubase_t t6;
# 86 "../../../../../../libcpu/risc-v/common/rt_hw_stack_frame.h"
}rt_hw_stack_frame_t;
# 5 "../../../../../../libcpu/risc-v/common/trap_common.c" 2

#define ISR_NUMBER 32
static volatile rt_hw_stack_frame_t *s_stack_frame;
static struct rt_irq_desc rv32irq_table[32];
...
__attribute__((weak)) rt_isr_handler_t rt_hw_interrupt_handle(rt_uint32_t mcause)
{
...
__attribute__((weak)) void rt_hw_interrupt_init(void)
{
    int idx = 0;
    ...
    for (idx = 0; idx < 32; idx++)
    {
        ...
        rv32irq_table[idx].param = 0;
    }
}
# 46 "../../../../../../libcpu/risc-v/common/trap_common.c"
__attribute__((weak)) rt_isr_handler_t rt_hw_interrupt_install(int vector, rt_isr_handler_t handler,
...
__attribute__((weak)) void rt_rv32_system_irq_handler(rt_uint32_t mcause)
{
    rt_uint32_t mscratch = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0x340" : "=r"(__tmp)); __tmp; });
...
__attribute__((weak)) void rt_show_stack_frame(void)
{
    rt_kprintf("Stack frame:\r\n----------------------------------------\r\n");
    rt_kprintf("ra      : 0x%08x\r\n", s_stack_frame->ra);
    rt_kprintf("mstatus : 0x%08x\r\n", ({ unsigned long __tmp; asm volatile ("csrr %0, " "0x300" : "=r"(__tmp)); __tmp; }));
