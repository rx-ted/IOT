# 1 "../../../../../../libcpu/risc-v/common/atomic_riscv.c"
...
# 1 "../../../../../../libcpu/risc-v/common/atomic_riscv.c"
# 11 "../../../../../../libcpu/risc-v/common/atomic_riscv.c"
...
# 12 "../../../../../../libcpu/risc-v/common/atomic_riscv.c" 2
...
rt_atomic_t rt_hw_atomic_compare_exchange_strong(volatile rt_atomic_t *ptr, volatile rt_atomic_t *old, rt_atomic_t new)
{
    ...
    asm volatile(
            ...
            : [new]"r" (new), [old]"r"(old)
            : "memory");
# 158 "../../../../../../libcpu/risc-v/common/atomic_riscv.c"
    return result;
}
