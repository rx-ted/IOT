...
const char __fsym_help_name[] __attribute__((section(".rodata.name"))) = "help"; const char __fsym_help_desc[] __attribute__((section(".rodata.name"))) = "RT-Thread shell help."; __attribute__((used)) const struct finsh_syscall __fsym_help __attribute__((section("FSymTab")))= { __fsym_help_name, __fsym_help_desc, (syscall_func)&msh_help };;
...
const char __fsym_ps_name[] __attribute__((section(".rodata.name"))) = "ps"; const char __fsym_ps_desc[] __attribute__((section(".rodata.name"))) = "List threads in the system."; __attribute__((used)) const struct finsh_syscall __fsym_ps __attribute__((section("FSymTab")))= { __fsym_ps_name, __fsym_ps_desc, (syscall_func)&cmd_ps };;
...
const char __fsym_free_name[] __attribute__((section(".rodata.name"))) = "free"; const char __fsym_free_desc[] __attribute__((section(".rodata.name"))) = "Show the memory usage in the system."; __attribute__((used)) const struct finsh_syscall __fsym_free __attribute__((section("FSymTab")))= { __fsym_free_name, __fsym_free_desc, (syscall_func)&cmd_free };;



static int msh_split(char *cmd, rt_size_t length, char *argv[10])
{
    char *ptr;
    rt_size_t position;
    rt_size_t argc;
...
# 737 "../../../../../../components/finsh/msh.c"
    ...
    if (name_ptr != 
# 762 "../../../../../../components/finsh/msh.c" 3
                   ((void *)0)
# 762 "../../../../../../components/finsh/msh.c"
                       )
    {
