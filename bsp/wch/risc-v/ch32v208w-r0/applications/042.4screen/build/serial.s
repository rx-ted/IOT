...
.Ltext0:
	...
	.section	.text._serial_check_buffer_size,"ax",@progbits
	.align	1
	.type	_serial_check_buffer_size, @function
_serial_check_buffer_size:
.LFB24:
	.file 1 "../../../../../../components/drivers/serial/serial.c"
	.loc 1 370 1
	.cfi_startproc
	.loc 1 371 5
	.loc 1 373 5
...
.LVL1:
	...
	add	a5,a5,a3
	jr	a5
	.section	.rodata.rt_serial_control,"a",@progbits
	.align	2
	.align	2
.L6:
	.word	.L4-.L6
	...
	.word	.L4-.L6
	.word	.L5-.L6
	.section	.text.rt_serial_control
.L9:
	.loc 1 1016 13
	.loc 1 1016 23 is_stmt 0
	lhu	a5,24(a0)
	ori	a5,a5,32
	sh	a5,24(a0)
...
.LVL6:
	...
	.loc 1 1028 20
	beq	a4,a5,.L12
	.loc 1 1028 77 discriminator 1
	lbu	a5,28(a0)
	.loc 1 1028 60 discriminator 1
	bnez	a5,.L14
.L12:
	.loc 1 1034 17 is_stmt 1
	.loc 1 1034 32 is_stmt 0
	lw	a5,0(a6)
	sw	a5,72(a0)
	lw	a5,4(a6)
	sw	a5,76(a0)
...
.L5:
	...
	beqz	a2,.L17
	.loc 1 1052 17 is_stmt 1
	.loc 1 1052 37 is_stmt 0
	li	a5,323
	sh	a5,0(a2)
	.loc 1 1006 14
	li	a0,0
...
.LVL73:
	...
	.loc 1 314 12
	bltu	a5,a4,.L44
	.loc 1 314 57 is_stmt 1
	.loc 1 314 76 is_stmt 0
	sh	zero,6(s0)
	j	.L44
.L56:
...
.L71:
	...
	and	a5,a1,a5
	beqz	a5,.L73
	.loc 1 624 33 discriminator 1
	lhu	a5,24(a0)
	.loc 1 624 25 discriminator 1
	li	a4,4096
	addi	a4,a4,-2048
	and	a5,a5,a4
	beqz	a5,.L84
...
.LVL104:
	...
	.loc 1 650 32 is_stmt 0
	sh	zero,4(s3)
	.loc 1 651 13 is_stmt 1
	.loc 1 651 32 is_stmt 0
	sh	zero,6(s3)
	.loc 1 652 13 is_stmt 1
	.loc 1 652 30 is_stmt 0
	sw	zero,8(s3)
	.loc 1 654 13 is_stmt 1
	.loc 1 654 31 is_stmt 0
	sw	s3,80(s0)
...
.LVL109:
	.loc 1 713 13
	.loc 1 713 31 is_stmt 0
	sw	s2,84(s0)
	.loc 1 715 13 is_stmt 1
	.loc 1 715 28 is_stmt 0
	lhu	a5,26(s0)
	ori	a5,a5,1024
	sh	a5,26(s0)
...
.LVL134:
	mv	s2,a0
.LVL135:
	.loc 1 1338 17 is_stmt 1
	.loc 1 1338 24 is_stmt 0
	lw	a5,0(s0)
	.loc 1 1338 40
	lhu	a4,4(s0)
	.loc 1 1338 32
	...
	.loc 1 1340 20
	bltu	a5,a4,.L103
	.loc 1 1340 65 is_stmt 1 discriminator 1
	.loc 1 1340 84 is_stmt 0 discriminator 1
	sh	zero,4(s0)
	j	.L103
.L111:
	.loc 1 1345 21 is_stmt 1
	.loc 1 1345 40 is_stmt 0
	addi	a5,a5,1
	slli	a5,a5,16
	srli	a5,a5,16
	sh	a5,6(s0)
	.loc 1 1346 21 is_stmt 1
	.loc 1 1346 38 is_stmt 0
	li	a4,1
	sw	a4,8(s0)
	.loc 1 1347 21 is_stmt 1
	.loc 1 1347 61 is_stmt 0
	lw	a4,76(s1)
	srli	a4,a4,10
	slli	a4,a4,16
	srli	a4,a4,16
	.loc 1 1347 24
	bltu	a5,a4,.L105
	.loc 1 1347 69 is_stmt 1 discriminator 1
	.loc 1 1347 88 is_stmt 0 discriminator 1
	sh	zero,6(s0)
.L105:
	.loc 1 1349 21 is_stmt 1
...
.LBB35:
	...
	.loc 1 1362 17
	.loc 1 1362 25 is_stmt 0
	call	rt_hw_interrupt_disable
.LVL138:
	.loc 1 1363 17 is_stmt 1
	.loc 1 1363 37 is_stmt 0
	lhu	a4,4(s0)
	.loc 1 1363 59
	lhu	a5,6(s0)
	.loc 1 1363 114
	bltu	a4,a5,.L108
	.loc 1 1363 93 discriminator 1
	sub	s0,a4,a5
.LVL139:
.L109:
	.loc 1 1365 17 is_stmt 1 discriminator 4
	call	rt_hw_interrupt_enable
.LVL140:
	.loc 1 1367 17 discriminator 4
	.loc 1 1367 20 is_stmt 0 discriminator 4
	beqz	s0,.L107
	.loc 1 1369 21 is_stmt 1
	.loc 1 1369 35 is_stmt 0
	lw	a5,32(s1)
	.loc 1 1369 21
	mv	a1,s0
	mv	a0,s1
...
.L108:
.LBB36:
	.loc 1 1364 36 is_stmt 0 discriminator 2
	lw	s0,76(s1)
.LVL144:
	srli	s0,s0,10
	slli	s0,s0,16
	srli	s0,s0,16
	.loc 1 1364 65 discriminator 2
	sub	a5,a5,a4
	.loc 1 1364 43 discriminator 2
	sub	s0,s0,a5
	j	.L109
.LVL145:
.L100:
...
.LFE32:
	...
	.section	.sbss.already_output.3688,"aw",@nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	already_output.3688, @object
	.size	already_output.3688, 4
already_output.3688:
	.zero	4
	.text
.Letext0:
	...
	.file 12 "../../../../../../components/drivers/include/drivers/serial.h"
...
.LASF1444:
	.string	"_write"
.LASF1577:
	.string	"../../../../../../components/drivers/serial/serial.c"
.LASF1239:
