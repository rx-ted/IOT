...
static rt_list_t _rt_thread_defunct = { &(_rt_thread_defunct), &(_rt_thread_defunct) };

static struct rt_thread idle_thread[1];
__attribute__((aligned(8)))
static rt_uint8_t idle_thread_stack[1][512];
# 69 "../../../../../../src/idle.c"
static void (*idle_hook_list[4])(void);
# 82 "../../../../../../src/idle.c"
rt_err_t rt_thread_idle_sethook(void (*hook)(void))
{
    rt_size_t i;
...
# 174 "../../../../../../src/idle.c"
    if (l->next != l)
    {
        thread = ((struct rt_thread *)((char *)(l->next) - (unsigned long)(&((struct rt_thread *)0)->tlist)))
...
void rt_thread_idle_init(void)
{
    ...
    char idle_thread_name[8];


    for (i = 0; i < 1; i++)
    {

        rt_snprintf(idle_thread_name, 8, "tidle%d", i);
