...
BKP_DeInit:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
	.loc 1 27 1
	.cfi_startproc
	addi	sp,sp,-16
...
.LFE18:
	...
	.align	1
	.globl	BKP_TamperPinLevelConfig
...
.LFE22:
	...
	.align	1
	.globl	BKP_SetRTCCalibrationValue
...
.Ldebug_macro0:
	...
	.byte	0x7
	.4byte	.LASF319
	.file 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_bkp.h"
	.byte	0x3
	.byte	0xa
	.byte	0xb
	.byte	0x5
...
.LASF5422:
	.string	"BKP_WriteBackupRegister"
.LASF2116:
...
.LASF5435:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
.LASF3766:
...
.LASF5431:
	.string	"BKP_TamperPinLevelConfig"
.LASF1447:
...
.LASF5191:
	.string	"OCTLR_MASK ((uint16_t)0xFC7F)"
.LASF662:
...
.LASF5190:
	.string	"OCTLR_CAL_MASK ((uint16_t)0xFF80)"
.LASF527:
...
.LASF5423:
	.string	"BKP_SetRTCCalibrationValue"
.LASF5179:
