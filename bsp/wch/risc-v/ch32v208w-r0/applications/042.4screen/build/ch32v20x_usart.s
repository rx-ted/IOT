...
USART_DeInit:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
	.loc 1 69 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-16
...
.LVL50:
	...
	.loc 1 225 39 is_stmt 0
	sh	zero,2(a0)
	.loc 1 226 5 is_stmt 1
	.loc 1 226 39 is_stmt 0
	sh	zero,4(a0)
	.loc 1 227 5 is_stmt 1
	.loc 1 227 42 is_stmt 0
	sh	zero,6(a0)
	.loc 1 228 1
	ret
	.cfi_endproc
...
.Letext0:
	...
	.file 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_usart.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 27 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_tim.h"
	.byte	0x3
	.byte	0x1c
	.byte	0x1b
	.byte	0x7
...
.Ldebug_macro46:
	...
	.4byte	.LASF5135
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.ch32v20x_usart.h.67.0d7d056692f039d81acedf250dd9b734,comdat
.Ldebug_macro47:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF5429:
	.string	"USART_StructInit"
.LASF2189:
	.string	"DMA_CFG7_CIRC ((uint16_t)0x0020)"
.LASF5218:
	.string	"CTLR3_ONEBITE_Set ((uint16_t)0x0800)"
.LASF4357:
...
.LASF5207:
	.string	"CTLR3_HDSEL_Set ((uint16_t)0x0008)"
.LASF637:
...
.LASF5204:
	.string	"CTLR3_SCEN_Reset ((uint16_t)0xFFDF)"
.LASF5019:
...
.LASF5201:
	.string	"CTLR2_STOP_CLEAR_Mask ((uint16_t)0xCFFF)"
.LASF2164:
...
.LASF5413:
	.string	"USART_LINBreakDetectLength"
.LASF1510:
...
.LASF5190:
	.string	"CTLR1_UE_Set ((uint16_t)0x2000)"
.LASF3779:
...
.LASF5198:
	.string	"CTLR2_LINEN_Set ((uint16_t)0x4000)"
.LASF1860:
...
.LASF5346:
	.string	"_asctime_buf"
.LASF5441:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
.LASF598:
...
.LASF5193:
	.string	"CTLR1_RWU_Set ((uint16_t)0x0002)"
.LASF1943:
...
.LASF5213:
	.string	"GPR_LSB_Mask ((uint16_t)0x00FF)"
.LASF676:
...
.LASF5203:
	.string	"CTLR3_SCEN_Set ((uint16_t)0x0020)"
.LASF250:
...
.LASF5412:
	.string	"USART_LINBreakDetectLengthConfig"
.LASF4255:
...
.LASF5419:
	.string	"USART_DMACmd"
.LASF5212:
	.string	"CTLR3_IREN_Reset ((uint16_t)0xFFFD)"
.LASF2070:
...
.LASF5208:
	.string	"CTLR3_HDSEL_Reset ((uint16_t)0xFFF7)"
.LASF1471:
...
.LASF5389:
	.string	"USART_ClearITPendingBit"
.LASF2030:
...
.LASF5199:
	.string	"CTLR2_LINEN_Reset ((uint16_t)0xBFFF)"
.LASF2208:
...
.LASF5197:
	.string	"CTLR2_Address_Mask ((uint16_t)0xFFF0)"
.LASF1781:
...
.LASF303:
	.string	"__riscv 1"
.LASF5219:
	.string	"CTLR3_ONEBITE_Reset ((uint16_t)0xF7FF)"
.LASF3853:
...
.LASF5205:
	.string	"CTLR3_NACK_Set ((uint16_t)0x0010)"
.LASF3578:
...
.LASF5196:
	.string	"CTLR1_CLEAR_Mask ((uint16_t)0xE9F3)"
.LASF4385:
...
.LASF5200:
	.string	"CTLR2_LBDL_Mask ((uint16_t)0xFFDF)"
.LASF2700:
...
.LASF5195:
	.string	"CTLR1_SBK_Set ((uint16_t)0x0001)"
.LASF313:
	.string	"USE_PLIC 1"
.LASF3136:
...
.LASF5216:
	.string	"CTLR1_OVER8_Set ((uint16_t)0x8000)"
.LASF4041:
...
.LASF5192:
	.string	"CTLR1_WAKE_Mask ((uint16_t)0xF7FF)"
.LASF1410:
...
.LASF5191:
	.string	"CTLR1_UE_Reset ((uint16_t)0xDFFF)"
.LASF62:
	.string	"__UINT_FAST8_TYPE__ unsigned int"
.LASF5427:
	.string	"USART_ClockInit"
.LASF2696:
...
.LASF5215:
	.string	"IT_Mask ((uint16_t)0x001F)"
.LASF1897:
...
.LASF5214:
	.string	"GPR_MSB_Mask ((uint16_t)0xFF00)"
.LASF4175:
...
.LASF5210:
	.string	"CTLR3_CLEAR_Mask ((uint16_t)0xFCFF)"
.LASF3846:
...
.LASF5211:
	.string	"CTLR3_IREN_Set ((uint16_t)0x0002)"
.LASF2020:
...
.LASF5202:
	.string	"CTLR2_CLOCK_CLEAR_Mask ((uint16_t)0xF0FF)"
.LASF3197:
...
.LASF5194:
	.string	"CTLR1_RWU_Reset ((uint16_t)0xFFFD)"
.LASF627:
...
.LASF5206:
	.string	"CTLR3_NACK_Reset ((uint16_t)0xFFEF)"
.LASF1591:
...
.LASF5414:
	.string	"USART_ReceiverWakeUpCmd"
.LASF943:
...
.LASF5217:
	.string	"CTLR1_OVER8_Reset ((uint16_t)0x7FFF)"
.LASF1066:
...
.LASF5209:
	.string	"CTLR3_IRLP_Mask ((uint16_t)0xFFFB)"
.LASF3083:
