# 1 "../../../../../../components/drivers/ipc/ringblk_buf.c"
...
# 1 "../../../../../../components/drivers/ipc/ringblk_buf.c"
# 11 "../../../../../../components/drivers/ipc/ringblk_buf.c"
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 12 "../../../../../../components/drivers/ipc/ringblk_buf.c" 2
...
# 14 "../../../../../../components/drivers/ipc/ringblk_buf.c" 2
# 26 "../../../../../../components/drivers/ipc/ringblk_buf.c"
void rt_rbb_init(rt_rbb_t rbb, rt_uint8_t *buf, rt_size_t buf_size, rt_rbb_blk_t block_set, rt_size_t blk_max_num)
{
    rt_size_t i;
...
;
# 62 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_rbb_t rt_rbb_create(rt_size_t buf_size, rt_size_t blk_max_num)
{
    rt_rbb_t rbb = 0;
    rt_uint8_t *buf;
...
static rt_rbb_blk_t find_empty_blk_in_set(rt_rbb_t rbb)
{
    ...
    blk = ((struct rt_rbb_blk *)((char *)((&rbb->free_list)->next) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
    rt_slist_remove(&rbb->free_list, &blk->list);
    ;
    return blk;
}

static __inline void list_append(rt_rbb_t rbb, rt_slist_t *n)
{
...
static __inline rt_slist_t *list_remove(rt_rbb_t rbb, rt_slist_t *n)
{
...
# 168 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_alloc(rt_rbb_t rbb, rt_size_t blk_size)
{
    rt_base_t level;
    rt_size_t empty1 = 0, empty2 = 0;
    rt_rbb_blk_t head, tail, new_rbb = 0;
    ...
    if (new_rbb)
    {
        if (rt_slist_isempty(&rbb->blk_list) == 0)
        {
            ...
            tail = ((struct rt_rbb_blk *)((char *)(rbb->tail) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
...
;
# 287 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_get(rt_rbb_t rbb)
{
    rt_base_t level;
    rt_rbb_blk_t block = 0;
    rt_slist_t *node;
...
;
# 327 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_size_t rt_rbb_blk_size(rt_rbb_blk_t block)
{
    ;
...
;
# 342 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_buf(rt_rbb_blk_t block)
{
    ;
...
;
# 396 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_get(rt_rbb_t rbb, rt_size_t queue_data_len, rt_rbb_blk_queue_t blk_queue)
{
    rt_base_t level;
    rt_size_t data_total_size = 0;
    rt_slist_t *node, *tmp = 0;
    rt_rbb_blk_t last_block = 0, block;
...
;
# 471 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_len(rt_rbb_blk_queue_t blk_queue)
{
    ...
    for (blk = blk_queue->blocks; i < blk_queue->blk_num; i++)
    {
        ...
        blk = ((struct rt_rbb_blk *)((char *)(blk->list.next) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
    }
    return data_total_size;
}
;
# 494 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_queue_buf(rt_rbb_blk_queue_t blk_queue)
{
    ;
...
void rt_rbb_blk_queue_free(rt_rbb_t rbb, rt_rbb_blk_queue_t blk_queue)
{
    ...
    for (blk = blk_queue->blocks; i < blk_queue->blk_num; i++)
    {
        next_blk = ((struct rt_rbb_blk *)((char *)(blk->list.next) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
        rt_rbb_blk_free(rbb, blk);
        blk = next_blk;
    }
}
;
# 533 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_size_t rt_rbb_next_blk_queue_len(rt_rbb_t rbb)
{
    rt_base_t level;
...
;
# 590 "../../../../../../components/drivers/ipc/ringblk_buf.c"
rt_size_t rt_rbb_get_buf_size(rt_rbb_t rbb)
{
    ;
