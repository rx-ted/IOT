# 1 "../../../../../../components/drivers/i2c/i2c_dev.c"
...
# 1 "../../../../../../components/drivers/i2c/i2c_dev.c"
# 13 "../../../../../../components/drivers/i2c/i2c_dev.c"
...
# 14 "../../../../../../components/drivers/i2c/i2c_dev.c" 2
...
# 22 "../../../../../../components/drivers/i2c/i2c_dev.c" 2
                                       ...
                                       void *args)
{
    ...
    case (((RT_Device_Class_I2CBUS + 1) * 0x100) + 0x01):
        bus->flags |= (1u << 2);
        break;
    case (((RT_Device_Class_I2CBUS + 1) * 0x100) + 0x03):
        bus->timeout = *(rt_uint32_t *)args;
        break;
    case (((RT_Device_Class_I2CBUS + 1) * 0x100) + 0x04):
        ...
        break;
    case (((RT_Device_Class_I2CBUS + 1) * 0x100) + 0x05):
...
# 118 "../../../../../../components/drivers/i2c/i2c_dev.c"
rt_err_t rt_i2c_bus_device_device_init(struct rt_i2c_bus_device *bus,
                                       const char *name)
{
