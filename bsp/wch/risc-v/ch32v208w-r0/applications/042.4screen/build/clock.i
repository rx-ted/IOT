...
void rt_tick_increase(void)
{
    ...
    do {if ((rt_tick_hook) != 0) rt_tick_hook (); } while (0);
...
;
# 167 "../../../../../../src/clock.c"
__attribute__((weak)) rt_tick_t rt_tick_get_millisecond(void)
{

    return rt_tick_get() * (1000u / 1000);
