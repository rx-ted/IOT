...
.Ltext0:
	...
	.section	.text.SetSysClockTo144_HSE,"ax",@progbits
	.align	1
	.type	SetSysClockTo144_HSE, @function
SetSysClockTo144_HSE:
.LFB21:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
	.loc 1 660 1
	.cfi_startproc
	addi	sp,sp,-16
	...
	sw	a5,0(a4)
.L3:
	.loc 1 666 3 is_stmt 1 discriminator 2
	.loc 1 668 5 discriminator 2
	.loc 1 668 79 is_stmt 0 discriminator 2
	li	a5,1073876992
	lw	a5,0(a5)
	.loc 1 668 86 discriminator 2
	li	a4,131072
	and	a5,a5,a4
	.loc 1 668 15 discriminator 2
	sw	a5,8(sp)
	.loc 1 669 5 is_stmt 1 discriminator 2
	.loc 1 669 19 is_stmt 0 discriminator 2
	lw	a5,12(sp)
	addi	a5,a5,1
	sw	a5,12(sp)
	.loc 1 670 22 discriminator 2
	lw	a5,8(sp)
	.loc 1 670 3 discriminator 2
	bnez	a5,.L2
	.loc 1 670 47 discriminator 1
	lw	a4,12(sp)
	.loc 1 670 28 discriminator 1
	li	a5,4096
	bne	a4,a5,.L3
.L2:
	.loc 1 672 3 is_stmt 1
	.loc 1 672 70 is_stmt 0
	li	a5,1073876992
	lw	a5,0(a5)
	.loc 1 672 6
	slli	a4,a5,14
...
.L10:
	...
	.loc 1 686 75 is_stmt 0
	lw	a4,4(a5)
	sw	a4,4(a5)
	.loc 1 688 5 is_stmt 1
	.loc 1 688 75 is_stmt 0
	lw	a4,4(a5)
	ori	a4,a4,1024
	sw	a4,4(a5)
	.loc 1 691 5 is_stmt 1
	.loc 1 691 75 is_stmt 0
	lw	a4,4(a5)
	li	a3,-4128768
	addi	a3,a3,-1
	and	a4,a4,a3
	...
	.loc 1 694 75 is_stmt 0
	lw	a4,4(a5)
	li	a3,3997696
	or	a4,a4,a3
	sw	a4,4(a5)
	.loc 1 697 5 is_stmt 1
	.loc 1 697 74 is_stmt 0
	lw	a4,0(a5)
	li	a3,16777216
	or	a4,a4,a3
	sw	a4,0(a5)
...
.L7:
	.loc 1 701 5 discriminator 1
	.loc 1 699 74 is_stmt 0 discriminator 1
	li	a5,1073876992
	lw	a5,0(a5)
	.loc 1 699 10 discriminator 1
	slli	a4,a5,6
	bgez	a4,.L7
	.loc 1 703 5 is_stmt 1
	.loc 1 703 75 is_stmt 0
	li	a5,1073876992
	lw	a4,4(a5)
	andi	a4,a4,-4
	sw	a4,4(a5)
	.loc 1 704 5 is_stmt 1
	.loc 1 704 75 is_stmt 0
	lw	a4,4(a5)
	ori	a4,a4,2
	sw	a4,4(a5)
...
.L8:
	...
	.loc 1 706 75 is_stmt 0 discriminator 1
	li	a5,1073876992
	lw	a5,4(a5)
	.loc 1 706 83 discriminator 1
	andi	a5,a5,12
	...
	.cfi_endproc
.LFE21:
	.size	SetSysClockTo144_HSE, .-SetSysClockTo144_HSE
...
.L17:
	.loc 1 143 7
	.loc 1 143 79 is_stmt 0
	li	a4,1073876992
	lw	a5,4(a4)
.LVL12:
	.loc 1 144 7 is_stmt 1
	.loc 1 144 81 is_stmt 0
	lw	a4,4(a4)
	.loc 1 144 17
	li	a3,65536
	and	a4,a4,a3
...
.LVL21:
.L22:
	.loc 1 155 15 is_stmt 1
	.loc 1 155 60 is_stmt 0
	li	a4,4001792
	addi	a4,a4,-1792
	mul	a5,a5,a4
.LVL22:
...
.Letext0:
	...
	.file 3 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x.h"
	...
	.file 9 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/include/core_riscv.h"
...
.Ldebug_macro0:
	...
	.byte	0x7
	.4byte	.Ldebug_macro5
	.file 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/include/ch32v20x_conf.h"
	.byte	0x3
	.byte	0xd1,0x25
	.byte	0xa
	.byte	0x5
	.byte	0xb
	.4byte	.LASF3611
	.file 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_adc.h"
	.byte	0x3
	.byte	0xd
	.byte	0xb
	.byte	0x5
...
.LASF5342:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
.LASF84:
...
.LASF5190:
	.string	"SYSCLK_FREQ_144MHz_HSE 144000000"
.LASF1395:
