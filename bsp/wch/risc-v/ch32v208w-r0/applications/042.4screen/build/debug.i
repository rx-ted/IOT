# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
...
# 12 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c" 2

static uint8_t p_us = 0;
static uint16_t p_ms = 0;
# 23 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void Delay_Init(void)
{
    p_us = SystemCoreClock / 8000000;
    p_ms = (uint16_t)p_us * 1000;
}
# 38 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void Delay_Us(uint32_t n)
{
    uint32_t i;

    ((SysTick_Type *) 0xE000F000)->SR &= ~(1 << 0);
    i = (uint32_t)n * p_us;

    ((SysTick_Type *) 0xE000F000)->CMP = i;
    ((SysTick_Type *) 0xE000F000)->CTLR |= (1 << 4) | (1 << 5) | (1 << 0);

    while((((SysTick_Type *) 0xE000F000)->SR & (1 << 0)) != (1 << 0))
        ;
    ((SysTick_Type *) 0xE000F000)->CTLR &= ~(1 << 0);
}
# 62 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void Delay_Ms(uint32_t n)
{
    uint32_t i;
...
# 86 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void USART_Printf_Init(uint32_t baudrate)
{
...
# 119 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
...
# 139 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
}
# 151 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
__attribute__((used)) int _write(int fd, char *buf, int size)
{
    ...
    for(i = 0; i < size; i++)
    {
        ...
        USART_SendData(((USART_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x3800)), *buf++);
...
# 179 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
void *_sbrk(ptrdiff_t incr)
{
    ...
    return 
# 186 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c" 3
          ((void *)0) 
# 186 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/debug.c"
               - 1;
