# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
# 12 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
...
# 13 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c" 2
# 25 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
#define SYSCLK_FREQ_144MHz_HSE 144000000
# 48 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
uint32_t SystemCoreClock = 144000000;
# 66 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
volatile const uint8_t AHBPrescTable[16] = {0, 0, 0, 0, 0, 0, 0, 0, 1, 2, 3, 4, 6, 7, 8, 9};



static void SetSysClock(void);
# 85 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
static void SetSysClockTo144_HSE( void );
# 109 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
...
# 128 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
void SystemCoreClockUpdate (void)
{
  ...
  switch (tmp)
  {
    ...
    case 0x08:
      ...
      else
      {
        ...
        {
          SystemCoreClock = ((((uint32_t)32000000)>>1)) * pllmull;
        }
        else
        ...
        if ((((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 & ((uint32_t)0x00020000)) != (uint32_t)RESET)
        {
          ...
          SystemCoreClock = ((((uint32_t)32000000)>>2) >> 1) * pllmull;
        ...
        else
        {
            ...
            SystemCoreClock = (((uint32_t)32000000)>>2) * pllmull;
  ...
  tmp = AHBPrescTable[((((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 & ((uint32_t)0x000000F0)) >> 4)];
  SystemCoreClock >>= tmp;
}
# 204 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
static void SetSysClock(void)
{
# 219 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
    SetSysClockTo144_HSE();
# 238 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
}
# 659 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/source/system_ch32v20x.c"
static void SetSysClockTo144_HSE(void)
{
  volatile uint32_t StartUpCounter = 0, HSEStatus = 0;

  ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CTLR |= ((uint32_t)((uint32_t)0x00010000));


  do
  {
    HSEStatus = ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CTLR & ((uint32_t)0x00020000);
    StartUpCounter++;
  } while((HSEStatus == 0) && (StartUpCounter != ((uint16_t)0x1000)));

  if ((((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CTLR & ((uint32_t)0x00020000)) != RESET)
  {
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 |= (uint32_t)((uint32_t)0x00000000);

    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 |= (uint32_t)((uint32_t)0x00000000);

    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 |= (uint32_t)((uint32_t)0x00000400);


    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 &= (uint32_t)((uint32_t)~(((uint32_t)0x00010000) | ((uint32_t)0x00020000) |
                                        ((uint32_t)0x003C0000)));

    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 |= (uint32_t)(((uint32_t)0x00010000) | ((uint32_t)0x00000000) | ((uint32_t)0x003C0000));


    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CTLR |= ((uint32_t)0x01000000);

    while((((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CTLR & ((uint32_t)0x02000000)) == 0)
    {
    }

    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 &= (uint32_t)((uint32_t)~(((uint32_t)0x00000003)));
    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR0 |= (uint32_t)((uint32_t)0x00000002);
