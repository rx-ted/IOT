# 1 "../../../../../../components/libc/compilers/common/ctime.c"
...
# 1 "../../../../../../components/libc/compilers/common/ctime.c"
# 24 "../../../../../../components/libc/compilers/common/ctime.c"
...
# 16 "../../../../../../components/libc/compilers/common/include/sys/time.h" 2
...
# 17 "../../../../../../components/libc/compilers/common/include/sys/time.h" 2
# 1 "../../board/stdint.h" 1
# 29 "../../board/stdint.h"
...
# 18 "../../../../../../components/libc/compilers/common/include/sys/time.h" 2
...
# 25 "../../../../../../components/libc/compilers/common/ctime.c" 2
...
# 26 "../../../../../../components/libc/compilers/common/ctime.c" 2
...
# 27 "../../../../../../components/libc/compilers/common/ctime.c" 2
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
# 31 "../../../../../../include/rthw.h"
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 28 "../../../../../../components/libc/compilers/common/ctime.c" 2
...
# 29 "../../../../../../components/libc/compilers/common/ctime.c" 2
...
#define __RTC_H__ 
# 24 "../../../../../../components/drivers/include/drivers/rtc.h"
...
# 37 "../../../../../../components/libc/compilers/common/ctime.c" 2
...
# 42 "../../../../../../components/libc/compilers/common/ctime.c" 2
...
static rt_err_t get_timeval(struct timeval *tv)
{
    ...
    if (device != 0)
    {
        if (rt_device_open(device, 0) == 0)
        {
            rst = rt_device_control(device, (((RT_Device_Class_RTC + 1) * 0x100) + 0x01), &tv->tv_sec);
            rt_device_control(device, (((RT_Device_Class_RTC + 1) * 0x100) + 0x03), tv);
...
static int set_timeval(struct timeval *tv)
{
    ...
    if (device != 0)
    {
        if (rt_device_open(device, 0) == 0)
        {
            rst = rt_device_control(device, (((RT_Device_Class_RTC + 1) * 0x100) + 0x02), &tv->tv_sec);
            rt_device_control(device, (((RT_Device_Class_RTC + 1) * 0x100) + 0x04), tv);
            rt_device_close(device);
        }
    }
    else
...
{
    int i;
    int work = *timep % (24*60*60);

    if(timep == 0 || r == 0)
    {
        rt_set_errno(
# 182 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    14
# 182 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return 0;
    }
...
char* asctime_r(const struct tm *t, char *buf)
{
    ...
    {
        rt_set_errno(
# 260 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    14
# 260 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return 0;
    }
...
;
# 349 "../../../../../../components/libc/compilers/common/ctime.c"
__attribute__((weak)) time_t time(time_t *t)
{
    ...
    {
        rt_set_errno(
# 363 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    14
# 363 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return ((time_t)-1);
    }
}
...
int stime(const time_t *t)
{
    ...
    {
        rt_set_errno(
# 381 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    14
# 381 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
    ...
    {
        rt_set_errno(
# 393 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    14
# 393 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
}
...
time_t timegm(struct tm * const t)
{
    ...
    {
        rt_set_errno(
# 407 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    14
# 407 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return (time_t)-1;
    }
    ...
    {
        rt_set_errno(
# 449 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    22
# 449 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return (time_t) -1;
    }
...
int gettimeofday(struct timeval *tv, struct timezone *tz)
{
    ...
    {
        rt_set_errno(
# 503 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    22
# 503 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
}
...
int settimeofday(const struct timeval *tv, const struct timezone *tz)
{
    ...
    if (tv != 0
        && tv->tv_usec >= 0
        && set_timeval((struct timeval *)tv) == 0)
    {
        return 0;
    }
    else
    {
        rt_set_errno(
# 524 "../../../../../../components/libc/compilers/common/ctime.c" 3
                    22
# 524 "../../../../../../components/libc/compilers/common/ctime.c"
                          );
        return -1;
    }
}
;
# 1361 "../../../../../../components/libc/compilers/common/ctime.c"
static volatile int8_t _current_timezone = 8;
