# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
...
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_pwr.h" 2
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c" 2
...
# 26 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_DeInit(void)
{
    RCC_APB1PeriphResetCmd(((uint32_t)0x10000000), ENABLE);
    RCC_APB1PeriphResetCmd(((uint32_t)0x10000000), DISABLE);
}
# 42 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_BackupAccessCmd(FunctionalState NewState)
{
    if(NewState)
    {
        ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR |= (1 << 8);
    }
    else
    {
        ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR &= ~(1 << 8);
...
# 63 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_PVDCmd(FunctionalState NewState)
{
    if(NewState)
    {
        ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR |= (1 << 4);
    }
    else
    {
        ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR &= ~(1 << 4);
...
# 93 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_PVDLevelConfig(uint32_t PWR_PVDLevel)
{
    uint32_t tmpreg = 0;
    tmpreg = ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR;
    tmpreg &= ((uint32_t)0xFFFFFF1F);
    tmpreg |= PWR_PVDLevel;
    ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR = tmpreg;
}
# 112 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_WakeUpPinCmd(FunctionalState NewState)
{
    if(NewState)
    {
...
# 138 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_EnterSTOPMode(uint32_t PWR_Regulator, uint8_t PWR_STOPEntry)
{
    uint32_t tmpreg = 0;
    tmpreg = ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR;
    ...
    ((PFIC_Type *) 0xE000E000 )->SCTLR |= (1 << 2);
...
# 167 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_EnterSTANDBYMode(void)
{
    ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR |= ((uint16_t)0x0004);
    ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR |= ((uint16_t)0x0002);
    ((PFIC_Type *) 0xE000E000 )->SCTLR |= (1 << 2);

    __WFI();
}
# 188 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
FlagStatus PWR_GetFlagStatus(uint32_t PWR_FLAG)
{
...
# 214 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_ClearFlag(uint32_t PWR_FLAG)
{
    ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR |= PWR_FLAG << 2;
}
# 226 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_EnterSTANDBYMode_RAM(void)
{
    uint32_t tmpreg = 0;
    tmpreg = ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR;

    tmpreg |= ((uint16_t)0x0004);
    tmpreg |= ((uint16_t)0x0002);
...
# 257 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_EnterSTANDBYMode_RAM_LV(void)
{
    uint32_t tmpreg = 0;
    tmpreg = ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR;
    ...
    tmpreg |= (0x1 << 20);
# 278 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
    ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR = tmpreg;
...
# 292 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_EnterSTANDBYMode_RAM_VBAT_EN(void)
{
    uint32_t tmpreg = 0;
    tmpreg = ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR;
...
# 323 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_EnterSTANDBYMode_RAM_LV_VBAT_EN(void)
{
    uint32_t tmpreg = 0;
    tmpreg = ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR;
    ...
    tmpreg |= (0x1 << 20);
# 344 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
    ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR = tmpreg;
...
# 366 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
void PWR_EnterSTOPMode_RAM_LV(uint32_t PWR_Regulator, uint8_t PWR_STOPEntry)
{
    uint32_t tmpreg = 0;
    tmpreg = ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR;
    ...
    tmpreg |= (0x1 << 20);
# 386 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_pwr.c"
    ((PWR_TypeDef *)((((uint32_t)0x40000000)) + 0x7000))->CTLR = tmpreg;
