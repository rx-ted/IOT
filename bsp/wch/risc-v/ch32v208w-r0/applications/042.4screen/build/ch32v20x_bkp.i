# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c" 2
...
# 26 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_DeInit(void)
{
    RCC_BackupResetCmd(ENABLE);
    RCC_BackupResetCmd(DISABLE);
}
# 43 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_TamperPinLevelConfig(uint16_t BKP_TamperPinLevel)
{
    if(BKP_TamperPinLevel)
    {
        ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCTLR |= (1 << 1);
    }
    else
    {
        ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCTLR &= ~(1 << 1);
...
# 64 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_TamperPinCmd(FunctionalState NewState)
{
    if(NewState)
    {
        ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCTLR |= (1 << 0);
    }
    else
    {
        ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCTLR &= ~(1 << 0);
...
# 85 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_ITConfig(FunctionalState NewState)
{
    if(NewState)
    {
        ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCSR |= (1 << 2);
    }
    else
    {
        ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCSR &= ~(1 << 2);
...
# 113 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_RTCOutputConfig(uint16_t BKP_RTCOutputSource)
{
    uint16_t tmpreg = 0;

    tmpreg = ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->OCTLR;
    tmpreg &= ((uint16_t)0xFC7F);
    tmpreg |= BKP_RTCOutputSource;
    ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->OCTLR = tmpreg;
}
# 133 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_SetRTCCalibrationValue(uint8_t CalibrationValue)
{
    uint16_t tmpreg = 0;
...
# 153 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_WriteBackupRegister(uint16_t BKP_DR, uint16_t Data)
{
...
# 172 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
uint16_t BKP_ReadBackupRegister(uint16_t BKP_DR)
{
    volatile uint32_t tmp = 0;
...
# 189 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
FlagStatus BKP_GetFlagStatus(void)
{
    if(((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCSR & (1 << 8))
    {
        return SET;
    }
    else
...
# 208 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_ClearFlag(void)
{
    ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCSR |= ((uint16_t)0x0001);
}
# 220 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
ITStatus BKP_GetITStatus(void)
{
    if(((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCSR & (1 << 9))
    {
        return SET;
    }
    else
...
# 239 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_bkp.c"
void BKP_ClearITPendingBit(void)
{
    ((BKP_TypeDef *)((((uint32_t)0x40000000)) + 0x6C00))->TPCSR |= ((uint16_t)0x0002);
}
