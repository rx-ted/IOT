...
const char __fsym_clear_name[] __attribute__((section(".rodata.name"))) = "clear"; const char __fsym_clear_desc[] __attribute__((section(".rodata.name"))) = "clear the terminal screen"; __attribute__((used)) const struct finsh_syscall __fsym_clear __attribute__((section("FSymTab")))= { __fsym_clear_name, __fsym_clear_desc, (syscall_func)&clear };;
...
const char __fsym_version_name[] __attribute__((section(".rodata.name"))) = "version"; const char __fsym_version_desc[] __attribute__((section(".rodata.name"))) = "show RT-Thread version information"; __attribute__((used)) const struct finsh_syscall __fsym_version __attribute__((section("FSymTab")))= { __fsym_version_name, __fsym_version_desc, (syscall_func)&version };;
...
static rt_list_t *list_get_next(rt_list_t *current, list_get_next_t *arg)
{
    ...
    if (!first_flag)
    {
        ...
        obj = ((struct rt_object *)((char *)(node) - (unsigned long)(&((struct rt_object *)0)->list)));
...
long list_thread(void)
{
    ...
    rt_list_t *obj_list[8];
    rt_list_t *next = (rt_list_t *)0;
    ...
    do
    {
        next = list_get_next(next, &find_arg);
        {
            ...
            for (i = 0; i < find_arg.nr_out; i++)
            {
                ...
                obj = ((struct rt_object *)((char *)(obj_list[i]) - (unsigned long)(&((struct rt_object *)0)->list)));
                level = rt_hw_interrupt_disable();
                ...
                thread = (struct rt_thread *)obj;
                {
                    rt_uint8_t stat;
                    rt_uint8_t *ptr;
# 212 "../../../../../../components/finsh/cmd.c"
                    rt_kprintf("%-*.*s %3d ", maxlen, 8, thread->name, thread->current_priority);

                    stat = (thread->stat & 0x07);
                    if (stat == 0x02) rt_kprintf(" ready  ");
                    else if ((stat & 0x04) == 0x04) rt_kprintf(" suspend");
                    else if (stat == 0x00) rt_kprintf(" init   ");
                    else if (stat == 0x01) rt_kprintf(" close  ");
                    else if (stat == 0x03) rt_kprintf(" running");
# 232 "../../../../../../components/finsh/cmd.c"
...
# 952 "../../../../../../components/finsh/cmd.c"
        else if(strcmp(argv[1], "device") == 0)
        {
            list_device();
        }
# 964 "../../../../../../components/finsh/cmd.c"
        else
        {
            goto _usage;
        }
...
const char __fsym_list_name[] __attribute__((section(".rodata.name"))) = "list"; const char __fsym_list_desc[] __attribute__((section(".rodata.name"))) = "list objects"; __attribute__((used)) const struct finsh_syscall __fsym_list __attribute__((section("FSymTab")))= { __fsym_list_name, __fsym_list_desc, (syscall_func)&cmd_list };;
