# 1 "../../../../../../components/drivers/serial/serial.c"
...
# 1 "../../../../../../components/drivers/serial/serial.c"
# 31 "../../../../../../components/drivers/serial/serial.c"
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 32 "../../../../../../components/drivers/serial/serial.c" 2
...
# 34 "../../../../../../components/drivers/serial/serial.c" 2
...
# 38 "../../../../../../components/drivers/serial/serial.c" 2
# 229 "../../../../../../components/drivers/serial/serial.c"
static __inline int _serial_poll_rx(struct rt_serial_device *serial, rt_uint8_t *data, int length)
{
    ...
    while (length)
    {
        ...
        *data = ch;
        ...
        if(serial->parent.open_flag & 0x040)
        {
            if (ch == '\n') break;
        }
    }
...
{
    static rt_bool_t already_output = 0;
...
# 590 "../../../../../../components/drivers/serial/serial.c"
...
static rt_err_t rt_serial_open(struct rt_device *dev, rt_uint16_t oflag)
{
    ...
    if (serial->serial_rx == 0)
    {
        if (oflag & 0x100)
        {
            ...
            serial->ops->control(serial, 0x06, (void *)0x100);
        }
# 688 "../../../../../../components/drivers/serial/serial.c"
        else
        {
            serial->serial_rx = 0;
        }
    ...
    if (serial->serial_tx == 0)
    {
        if (oflag & 0x400)
        {
            ...
            serial->ops->control(serial, 0x06, (void *)0x400);
        }
# 736 "../../../../../../components/drivers/serial/serial.c"
        else
        {
            serial->serial_tx = 0;
        }
...
static rt_err_t rt_serial_close(struct rt_device *dev)
{
    ...
    if (dev->open_flag & 0x100)
    {
        ...
        serial->ops->control(serial, 0x07, (void*)0x100);
        dev->open_flag &= ~0x100;
...
# 812 "../../../../../../components/drivers/serial/serial.c"
    if (dev->open_flag & 0x400)
    {
        struct rt_serial_tx_fifo* tx_fifo;

        serial->ops->control(serial, 0x07, (void*)0x400);
        dev->open_flag &= ~0x400;
...
# 847 "../../../../../../components/drivers/serial/serial.c"
    serial->ops->control(serial, 0x04, 0);
    dev->flag &= ~0x010;
...
# 1002 "../../../../../../components/drivers/serial/serial.c"
                                  ...
                                  void *args)
{
    ...
    switch (cmd)
    {
        ...
        case 0x09:
            if (args)
            {
                *(rt_uint16_t*)args = 0x003 | 0x100 | 0x040;
            }
            break;
# 1252 "../../../../../../components/drivers/serial/serial.c"
        default :
...
# 1276 "../../../../../../components/drivers/serial/serial.c"
rt_err_t rt_hw_serial_register(struct rt_serial_device *serial,
                               const char *name,
                               rt_uint32_t flag,
                               void *data)
...
# 1453 "../../../../../../components/drivers/serial/serial.c"
    }
}
