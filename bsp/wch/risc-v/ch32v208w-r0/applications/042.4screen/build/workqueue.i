# 1 "../../../../../../components/drivers/ipc/workqueue.c"
...
# 1 "../../../../../../components/drivers/ipc/workqueue.c"
# 14 "../../../../../../components/drivers/ipc/workqueue.c"
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 15 "../../../../../../components/drivers/ipc/workqueue.c" 2
...
# 17 "../../../../../../components/drivers/ipc/workqueue.c" 2
                                       ...
                                       struct rt_work *work, rt_tick_t ticks)
{
    ...
    if (ticks == 0)
    {
        ...
        if (queue->work_current == 0 &&
                ((queue->work_thread->stat & 0x04) == 0x04))
        {
    ...
    else if (ticks < 0xffffffffUL / 2)
    {

        if (work->flags & RT_WORK_STATE_SUBMITTING)
        {
            rt_timer_stop(&work->timer);
            rt_timer_control(&work->timer, 0x0, &ticks);
        }
        else
        {
...
static rt_err_t _workqueue_cancel_work(struct rt_workqueue *queue, struct rt_work *work)
{
    ...
    err = queue->work_current != work ? 0 : -7;
    work->workqueue = 0;
    rt_hw_interrupt_enable(level);
    return err;
}
...
# 215 "../../../../../../components/drivers/ipc/workqueue.c"
...
# 241 "../../../../../../components/drivers/ipc/workqueue.c"
struct rt_workqueue *rt_workqueue_create(const char *name, rt_uint16_t stack_size, rt_uint8_t priority)
{
...
# 275 "../../../../../../components/drivers/ipc/workqueue.c"
rt_err_t rt_workqueue_destroy(struct rt_workqueue *queue)
{
    ;
...
# 297 "../../../../../../components/drivers/ipc/workqueue.c"
rt_err_t rt_workqueue_dowork(struct rt_workqueue *queue, struct rt_work *work)
{
    ;
    ;
...
# 320 "../../../../../../components/drivers/ipc/workqueue.c"
rt_err_t rt_workqueue_submit_work(struct rt_workqueue *queue, struct rt_work *work, rt_tick_t ticks)
{
    ;
    ;
...
# 338 "../../../../../../components/drivers/ipc/workqueue.c"
rt_err_t rt_workqueue_urgent_work(struct rt_workqueue *queue, struct rt_work *work)
{
    rt_base_t level;
...
# 376 "../../../../../../components/drivers/ipc/workqueue.c"
rt_err_t rt_workqueue_cancel_work(struct rt_workqueue *queue, struct rt_work *work)
{
    ;
    ;
...
# 393 "../../../../../../components/drivers/ipc/workqueue.c"
rt_err_t rt_workqueue_cancel_work_sync(struct rt_workqueue *queue, struct rt_work *work)
{
    ;
    ;
...
# 418 "../../../../../../components/drivers/ipc/workqueue.c"
rt_err_t rt_workqueue_cancel_all_work(struct rt_workqueue *queue)
{
    struct rt_work *work;
    ...
    rt_enter_critical();
    while (rt_list_isempty(&queue->work_list) == 0)
    {
        work = ((struct rt_work *)((char *)((&queue->work_list)->next) - (unsigned long)(&((struct rt_work *)0)->list)));
        _workqueue_cancel_work(queue, work);
    }

    while (rt_list_isempty(&queue->delayed_list) == 0)
    {
        work = ((struct rt_work *)((char *)((&queue->delayed_list)->next) - (unsigned long)(&((struct rt_work *)0)->list)));
        _workqueue_cancel_work(queue, work);
    }
    rt_exit_critical();
