...
.Ltext0:
	...
	.section	.text.rt_hwtimer_init,"ax",@progbits
	.align	1
	.type	rt_hwtimer_init, @function
rt_hwtimer_init:
.LFB21:
	.file 1 "../../../../../../components/drivers/hwtimer/hwtimer.c"
	.loc 1 77 1
	.cfi_startproc
.LVL0:
	.loc 1 78 5
...
.LVL3:
	...
	.cfi_endproc
.LFE21:
	.size	rt_hwtimer_init, .-rt_hwtimer_init
	.section	.text.rt_hwtimer_open,"ax",@progbits
	.align	1
	.type	rt_hwtimer_open, @function
rt_hwtimer_open:
.LFB22:
...
.LVL8:
	...
	.cfi_endproc
.LFE22:
	.size	rt_hwtimer_open, .-rt_hwtimer_open
	.section	.text.rt_hwtimer_close,"ax",@progbits
	.align	1
	.type	rt_hwtimer_close, @function
rt_hwtimer_close:
.LFB23:
...
.L19:
	...
	.cfi_endproc
.LFE23:
	.size	rt_hwtimer_close, .-rt_hwtimer_close
	.section	.text.rt_hwtimer_control,"ax",@progbits
	.align	1
	.type	rt_hwtimer_control, @function
rt_hwtimer_control:
.LFB26:
...
.LVL21:
	...
	lw	a4,4(a4)
	.loc 1 243 41 discriminator 1
	blt	a5,a4,.L31
	.loc 1 250 9 is_stmt 1
	.loc 1 250 18 is_stmt 0
	lw	a5,68(a0)
	.loc 1 250 23
	lw	a5,16(a5)
	.loc 1 250 12
...
.LBE5:
	...
	.cfi_endproc
.LFE26:
	.size	rt_hwtimer_control, .-rt_hwtimer_control
	.globl	__floatunsisf
	.globl	__floatsisf
	.globl	__divsf3
	.globl	__addsf3
	...
	.globl	__gtsf2
	.globl	__eqsf2
	.section	.text.rt_hwtimer_write,"ax",@progbits
	.align	1
	.type	rt_hwtimer_write, @function
rt_hwtimer_write:
.LFB25:
...
.LVL73:
	mv	s3,a0
.LVL74:
	.loc 1 49 17 is_stmt 1
	.loc 1 49 20 is_stmt 0
	mv	a1,s7
	call	__gtsf2
.LVL75:
	bgtz	a0,.L67
	.loc 1 55 22 is_stmt 1
...
.L53:
	...
	.cfi_endproc
.LFE25:
	.size	rt_hwtimer_write, .-rt_hwtimer_write
	.globl	__fixsfsi
	.section	.text.rt_hwtimer_read,"ax",@progbits
	.align	1
	.type	rt_hwtimer_read, @function
rt_hwtimer_read:
.LFB24:
...
.LVL134:
	...
	.cfi_endproc
.LFE24:
	.size	rt_hwtimer_read, .-rt_hwtimer_read
	.section	.text.rt_device_hwtimer_isr,"ax",@progbits
	.align	1
	.globl	rt_device_hwtimer_isr
	.type	rt_device_hwtimer_isr, @function
...
.LVL142:
	...
	.cfi_endproc
.LFE27:
	.size	rt_device_hwtimer_isr, .-rt_device_hwtimer_isr
	.section	.text.rt_device_hwtimer_register,"ax",@progbits
	.align	1
	.globl	rt_device_hwtimer_register
	.type	rt_device_hwtimer_register, @function
...
.LVL146:
	...
	.cfi_endproc
.LFE28:
	.size	rt_device_hwtimer_register, .-rt_device_hwtimer_register
	.section	.rodata.rt_hwtimer_write.cst4,"aM",@progbits,4
	.align	2
.LC0:
	.word	1065353216
.LC1:
...
.Letext0:
	...
	.file 11 "../../../../../../components/drivers/include/drivers/hwtimer.h"
...
.LASF1563:
	.string	"../../../../../../components/drivers/hwtimer/hwtimer.c"
.LASF1185:
...
.LASF1514:
	.string	"HWTIMER_MODE_PERIOD"
.LASF1286:
	.string	"DBG_LVL DBG_INFO"
.LASF568:
	.string	"_BSD_WCHAR_T_"
.LASF1548:
	.string	"rt_hwtimer_close"
.LASF71:
...
.LASF1566:
	.string	"rt_device_hwtimer_register"
.LASF385:
...
.LASF1551:
	.string	"rt_hwtimer_init"
.LASF1544:
	.string	"rt_hwtimer_write"
.LASF992:
