# 1 "../../../../../../libcpu/risc-v/common/cpuport.c"
...
# 1 "../../../../../../libcpu/risc-v/common/cpuport.c"
# 13 "../../../../../../libcpu/risc-v/common/cpuport.c"
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 14 "../../../../../../libcpu/risc-v/common/cpuport.c" 2
...
#define LOAD lw
#define REGBYTES 4
# 17 "../../../../../../libcpu/risc-v/common/cpuport.c" 2
...
# 18 "../../../../../../libcpu/risc-v/common/cpuport.c" 2


volatile rt_ubase_t rt_interrupt_from_thread = 0;
volatile rt_ubase_t rt_interrupt_to_thread = 0;
volatile rt_uint32_t rt_thread_switch_interrupt_flag = 0;
# 35 "../../../../../../libcpu/risc-v/common/cpuport.c"
                             ...
                             void *texit)
{
    ...
    stk = (rt_uint8_t *)(((rt_ubase_t)stk) & ~((4) - 1));
...
__attribute__((weak)) void rt_trigger_software_interrupt(void)
{
    while (0);
}

__attribute__((weak)) void rt_hw_do_after_save_above(void)
{
    while (1);
}
# 87 "../../../../../../libcpu/risc-v/common/cpuport.c"
__attribute__((weak)) void rt_hw_context_switch_interrupt(rt_ubase_t from, rt_ubase_t to, rt_thread_t from_thread, rt_thread_t to_thread)
{
...
__attribute__((weak)) void rt_hw_cpu_shutdown()
{
    rt_base_t level;
    rt_kprintf("shutdown...\n");
