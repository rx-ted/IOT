...
static uint32_t _SysTick_Config(rt_uint32_t ticks)
{
    ...
    ((SysTick_Type *) 0xE000F000)->CTLR=0;
    ((SysTick_Type *) 0xE000F000)->SR=0;
    ((SysTick_Type *) 0xE000F000)->CNT=0;
    ((SysTick_Type *) 0xE000F000)->CMP=ticks-1;
    ((SysTick_Type *) 0xE000F000)->CTLR=0xF;
    return 0;
}


#define RT_HEAP_SIZE (1024*10)
static uint32_t rt_heap[(1024*10)];
__attribute__((weak)) void *rt_heap_begin_get(void)
{
    return rt_heap;
}

__attribute__((weak)) void *rt_heap_end_get(void)
{
    return rt_heap + (1024*10);
}
