...
GPIO_DeInit:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
	.loc 1 36 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-16
...
.LVL24:
	...
	.loc 1 91 5
	.loc 1 93 5
	.loc 1 93 45 is_stmt 0
	lw	a5,8(a1)
	.loc 1 93 17
	andi	a7,a5,15
.LVL25:
	.loc 1 95 5 is_stmt 1
	.loc 1 95 48 is_stmt 0
	andi	a5,a5,16
	.loc 1 95 7
	beqz	a5,.L16
	.loc 1 97 9 is_stmt 1
	.loc 1 97 49 is_stmt 0
	lw	a5,4(a1)
	.loc 1 97 21
	or	a7,a7,a5
.LVL26:
...
.LVL28:
.L28:
	.loc 1 128 21 is_stmt 1
	.loc 1 128 32 is_stmt 0
	sw	a5,20(a0)
.LVL29:
.L19:
	.loc 1 114 49 discriminator 2
	addi	a4,a4,1
.LVL30:
.L18:
...
.L30:
	...
	.loc 1 160 32 is_stmt 0
	sw	a5,20(a0)
.LVL46:
	j	.L25
.LVL47:
.L24:
	.loc 1 146 49 discriminator 2
	addi	a4,a4,1
.LVL48:
.L23:
...
.L64:
	...
	.loc 1 571 11
	beq	a7,a6,.L66
	.loc 1 576 14 is_stmt 1
	.loc 1 576 16 is_stmt 0
	slli	a6,a0,11
	bgez	a6,.L57
	.loc 1 578 13 is_stmt 1
	.loc 1 578 18 is_stmt 0
	li	a6,3
	sll	a4,a6,a4
.LVL104:
...
.LFE34:
	...
	.align	1
	.globl	GPIO_ETH_MediaInterfaceConfig
...
.Letext0:
	...
	.file 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_gpio.h"
...
.Ldebug_macro46:
	...
	.4byte	.LASF5099
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.ch32v20x_gpio.h.62.b87e3b2fe30a0241f14a8042a14f595e,comdat
.Ldebug_macro47:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF5194:
	.string	"DBGAFR_LOCATION_MASK ((uint32_t)0x00200000)"
.LASF4637:
...
.LASF5359:
	.string	"GPIO_ETH_MediaInterface"
.LASF5139:
...
.LASF5195:
	.string	"DBGAFR_NUMBITS_MASK ((uint32_t)0x00100000)"
.LASF1280:
...
.LASF5357:
	.string	"GPIO_ETH_MediaInterfaceConfig"
.LASF4714:
	.string	"__need_NULL "
.LASF584:
...
.LASF5393:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_gpio.c"
.LASF330:
...
.LASF5193:
	.string	"DBGAFR_SWJCFG_MASK ((uint32_t)0xF0FFFFFF)"
.LASF1423:
...
.LASF5191:
	.string	"LSB_MASK ((uint16_t)0xFFFF)"
.LASF152:
...
.LASF353:
	.string	"UINT64_MAX"
.LASF5192:
	.string	"DBGAFR_POSITION_MASK ((uint32_t)0x000F0000)"
.LASF947:
...
.LASF5190:
	.string	"ECR_PORTPINCONFIG_MASK ((uint16_t)0xFF80)"
.LASF2409:
