...
i2c_start:
.LFB23:
	.file 1 "../../../../../../components/drivers/i2c/i2c-bit-ops.c"
	.loc 1 74 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-16
...
.LFE23:
	...
	.section	.text.SCL_H,"ax",@progbits
	.align	1
	.type	SCL_H, @function
SCL_H:
.LFB22:
...
.LFE22:
	.size	SCL_H, .-SCL_H
	.section	.text.i2c_restart,"ax",@progbits
	.align	1
...
.LFE24:
	...
	.section	.text.i2c_writeb,"ax",@progbits
	.align	1
	.type	i2c_writeb, @function
i2c_writeb:
.LFB27:
...
.LVL48:
	...
	.cfi_endproc
.LFE27:
	.size	i2c_writeb, .-i2c_writeb
	.section	.text.i2c_send_bytes,"ax",@progbits
	.align	1
	.type	i2c_send_bytes, @function
i2c_send_bytes:
.LFB29:
...
.LVL64:
	...
	.cfi_endproc
.LFE29:
	.size	i2c_send_bytes, .-i2c_send_bytes
	.section	.text.i2c_readb,"ax",@progbits
	.align	1
	.type	i2c_readb, @function
i2c_readb:
.LFB28:
...
.LVL71:
.L32:
	.loc 1 182 9 is_stmt 1 discriminator 2
	.loc 1 182 12 is_stmt 0 discriminator 2
	lw	a5,8(s0)
	...
	jalr	a5
.LVL72:
	.loc 1 183 9 is_stmt 1 discriminator 2
.LBB62:
.LBB63:
	.loc 1 33 5 discriminator 2
	.loc 1 33 8 is_stmt 0 discriminator 2
	lw	a5,20(s0)
	.loc 1 33 5 discriminator 2
	lw	a0,24(s0)
	jalr	a5
...
.L34:
	...
	.cfi_endproc
.LFE28:
	.size	i2c_readb, .-i2c_readb
	.section	.text.i2c_send_ack_or_nack,"ax",@progbits
	.align	1
	.type	i2c_send_ack_or_nack, @function
...
.L40:
	...
	.cfi_endproc
.LFE30:
	.size	i2c_send_ack_or_nack, .-i2c_send_ack_or_nack
	.section	.text.i2c_recv_bytes,"ax",@progbits
	.align	1
	.type	i2c_recv_bytes, @function
i2c_recv_bytes:
.LFB31:
...
.LVL111:
	...
	.cfi_endproc
.LFE31:
	.size	i2c_recv_bytes, .-i2c_recv_bytes
...
.LFE25:
	...
	.section	.text.i2c_send_address,"ax",@progbits
	.align	1
	.type	i2c_send_address, @function
i2c_send_address:
.LFB32:
...
.LVL125:
	...
	li	a5,1
	beq	a0,a5,.L51
	.loc 1 294 22 discriminator 1
	beq	s0,s3,.L51
	.loc 1 296 9 is_stmt 1 discriminator 2
...
.LBE73:
.LBE72:
	.loc 1 299 9 is_stmt 1 discriminator 2
	.loc 1 300 9 discriminator 2
	mv	a0,s1
	call	i2c_start
.LVL129:
	.loc 1 291 32 is_stmt 0 discriminator 2
	addi	s0,s0,1
.LVL130:
	j	.L52
.L51:
...
.LVL135:
	...
	.cfi_endproc
.LFE32:
	.size	i2c_send_address, .-i2c_send_address
	.section	.text.i2c_bit_send_address,"ax",@progbits
	.align	1
	.type	i2c_bit_send_address, @function
...
.L57:
.LVL140:
	.loc 1 319 5 is_stmt 1 discriminator 4
	.loc 1 319 8 is_stmt 0 discriminator 4
	andi	a5,s0,4
	bnez	a5,.L72
...
.LVL177:
	...
	.cfi_endproc
.LFE33:
	.size	i2c_bit_send_address, .-i2c_bit_send_address
	.section	.text.i2c_bit_xfer,"ax",@progbits
	.align	1
	.type	i2c_bit_xfer, @function
i2c_bit_xfer:
.LFB34:
...
.LVL183:
	...
	.loc 1 409 17
	.loc 1 411 13
	.loc 1 411 26 is_stmt 0
	lhu	a5,4(s0)
	.loc 1 411 16
	bgt	a5,a0,.L90
.L82:
	.loc 1 381 27 discriminator 2
	addi	s1,s1,1
.LVL184:
.L76:
	.loc 1 381 5 discriminator 1
	bgeu	s1,s3,.L91
...
.L86:
	...
	.cfi_endproc
.LFE34:
	.size	i2c_bit_xfer, .-i2c_bit_xfer
	.section	.text.rt_i2c_bit_add_bus,"ax",@progbits
	.align	1
	.globl	rt_i2c_bit_add_bus
	.type	rt_i2c_bit_add_bus, @function
rt_i2c_bit_add_bus:
.LFB35:
...
.LVL204:
	...
	.cfi_endproc
.LFE35:
	.size	rt_i2c_bit_add_bus, .-rt_i2c_bit_add_bus
	.section	.rodata.i2c_bit_bus_ops,"a"
	.align	2
	.set	.LANCHOR0,. + 0
	.type	i2c_bit_bus_ops, @object
	.size	i2c_bit_bus_ops, 12
i2c_bit_bus_ops:
	.word	i2c_bit_xfer
	.word	0
	.word	0
...
.Letext0:
	...
	.file 12 "../../../../../../components/drivers/include/drivers/i2c-bit-ops.h"
...
.LASF1285:
	.string	"SET_SDA(ops,val) ops->set_sda(ops->data, val)"
.LASF467:
...
.LASF1291:
	.string	"SCL_L(ops) SET_SCL(ops, 0)"
.LASF1092:
...
.LASF1287:
	.string	"GET_SDA(ops) ops->get_sda(ops->data)"
.LASF1368:
...
.LASF1442:
	.string	"__tm_year"
.LASF1289:
	.string	"SDA_L(ops) SET_SDA(ops, 0)"
.LASF148:
...
.LASF1515:
	.string	"_signal_buf"
.LASF1290:
	.string	"SDA_H(ops) SET_SDA(ops, 1)"
.LASF897:
	.string	"RT_EIO 8"
.LASF681:
...
.LASF1582:
	.string	"i2c_waitack"
.LASF1286:
	.string	"SET_SCL(ops,val) ops->set_scl(ops->data, val)"
.LASF795:
	.string	"unsigned"
.LASF344:
...
.LASF1578:
	.string	"../../../../../../components/drivers/i2c/i2c-bit-ops.c"
.LASF1457:
	.string	"__sFILE"
.LASF382:
...
.LASF1343:
	.string	"parent"
.LASF1288:
	.string	"GET_SCL(ops) ops->get_scl(ops->data)"
.LASF622:
