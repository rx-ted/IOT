...
SPI_I2S_DeInit:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_spi.c"
	.loc 1 56 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-16
...
.Letext0:
	...
	.file 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_spi.h"
...
.Ldebug_macro46:
	...
	.4byte	.LASF5115
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.ch32v20x_spi.h.77.c0b86e97ff349b18481fb577e2f7336c,comdat
.Ldebug_macro47:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF5198:
	.string	"CTLR2_SSOE_Reset ((uint16_t)0xFFFB)"
.LASF1804:
...
.LASF5404:
	.string	"SPI_NSSInternalSoftwareConfig"
.LASF435:
	.string	"INT16_C"
.LASF3542:
...
.LASF5196:
	.string	"CTLR1_CRCEN_Reset ((uint16_t)0xDFFF)"
.LASF2164:
...
.LASF5203:
	.string	"I2S2_CLOCK_SRC ((uint32_t)(0x00020000))"
.LASF1518:
...
.LASF5059:
	.string	"__SWR 0x0008"
.LASF5205:
	.string	"I2S_MUL_MASK ((uint32_t)(0x0000F000))"
.LASF1275:
...
.LASF5190:
	.string	"CTLR1_SPE_Set ((uint16_t)0x0040)"
.LASF1374:
...
.LASF5192:
	.string	"I2SCFGR_I2SE_Set ((uint16_t)0x0400)"
.LASF3454:
...
.LASF5202:
	.string	"I2S_Mode_Select ((uint16_t)0x0800)"
.LASF3496:
...
.LASF5431:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_spi.c"
.LASF1138:
...
.LASF5195:
	.string	"CTLR1_CRCEN_Set ((uint16_t)0x2000)"
.LASF2732:
...
.LASF5199:
	.string	"CTLR1_CLEAR_Mask ((uint16_t)0x3040)"
.LASF747:
...
.LASF5409:
	.string	"SPI_I2S_DMACmd"
.LASF5394:
	.string	"SPI_BiDirectionalLineConfig"
.LASF3484:
...
.LASF5201:
	.string	"SPI_Mode_Select ((uint16_t)0xF7FF)"
.LASF4541:
...
.LASF5204:
	.string	"I2S3_CLOCK_SRC ((uint32_t)(0x00040000))"
.LASF321:
	.string	"__CH32V20x_H "
.LASF630:
...
.LASF5193:
	.string	"I2SCFGR_I2SE_Reset ((uint16_t)0xFBFF)"
.LASF4680:
	.string	"__NEWLIB__ 3"
.LASF3636:
...
.LASF5389:
	.string	"SPI_I2S_ClearITPendingBit"
.LASF3147:
...
.LASF5194:
	.string	"CTLR1_CRCNext_Set ((uint16_t)0x1000)"
.LASF3671:
...
.LASF5206:
	.string	"I2S_DIV_MASK ((uint32_t)(0x000000F0))"
.LASF2409:
...
.LASF5200:
	.string	"I2SCFGR_CLEAR_Mask ((uint16_t)0xF040)"
.LASF913:
...
.LASF5197:
	.string	"CTLR2_SSOE_Set ((uint16_t)0x0004)"
.LASF3719:
...
.LASF5191:
	.string	"CTLR1_SPE_Reset ((uint16_t)0xFFBF)"
.LASF4340:
