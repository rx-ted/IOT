...
.Ltext0:
	...
	.section	.text._scheduler_get_highest_priority_thread,"ax",@progbits
	.align	1
	.type	_scheduler_get_highest_priority_thread, @function
_scheduler_get_highest_priority_thread:
.LFB17:
	.file 1 "../../../../../../src/scheduler_up.c"
	.loc 1 142 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-16
	...
	lla	a5,rt_thread_ready_priority_group
	lw	a0,0(a5)
.LVL1:
	call	__rt_ffs
.LVL2:
...
.LVL3:
	...
	.loc 1 156 110 is_stmt 0
	slli	a3,a4,3
	lla	a5,rt_thread_priority_table
	add	a5,a5,a3
	lw	a0,0(a5)
.LVL4:
...
.LVL6:
	...
	.cfi_endproc
.LFE17:
	.size	_scheduler_get_highest_priority_thread, .-_scheduler_get_highest_priority_thread
...
.LFE15:
	...
	.section	.text.rt_scheduler_switch_sethook,"ax",@progbits
	.align	1
	.globl	rt_scheduler_switch_sethook
	.type	rt_scheduler_switch_sethook, @function
...
.LVL8:
	...
	.cfi_endproc
.LFE16:
	.size	rt_scheduler_switch_sethook, .-rt_scheduler_switch_sethook
...
.LFB18:
	...
	.loc 1 170 5
	.loc 1 171 5
	.loc 1 171 28 is_stmt 0
	sh	zero,.LANCHOR2,a5
	.loc 1 174 63 is_stmt 1
	.loc 1 176 5
.LVL9:
...
.LVL10:
.L6:
	.loc 1 176 5 discriminator 1
	li	a5,31
	bgt	a4,a5,.L8
	.loc 1 178 9 is_stmt 1 discriminator 3
	slli	a5,a4,3
	lla	a3,rt_thread_priority_table
	add	a5,a5,a3
.LVL11:
.LBB12:
.LBB13:
...
.L8:
	...
	sw	zero,rt_thread_ready_priority_group,a5
	.loc 1 188 1
	ret
	.cfi_endproc
.LFE18:
...
.LBE15:
.LBE14:
	.loc 1 387 92 is_stmt 1
	.loc 1 393 5
	.loc 1 393 45 is_stmt 0
	lw	a3,56(s0)
	.loc 1 393 36
	lla	a4,rt_thread_ready_priority_group
	lw	a5,0(a4)
	or	a5,a5,a3
	sw	a5,0(a4)
.L11:
...
.L19:
	...
	.loc 1 431 50 is_stmt 0
	lw	a5,56(s0)
	.loc 1 431 43
	not	a4,a5
	.loc 1 431 40
	lla	a3,rt_thread_ready_priority_group
	lw	a5,0(a3)
	and	a5,a5,a4
	sw	a5,0(a3)
	j	.L17
...
.LFB19:
	...
	addi	a0,sp,12
	call	_scheduler_get_highest_priority_thread
.LVL31:
	mv	s0,a0
.LVL32:
...
.L25:
	...
	lbu	a5,12(sp)
	.loc 1 264 37
	sb	a5,rt_current_priority,a4
	.loc 1 265 17 is_stmt 1
.LVL44:
	.loc 1 266 17
	.loc 1 266 35 is_stmt 0
	sw	s1,.LANCHOR3,a5
	.loc 1 268 17 is_stmt 1
	.loc 1 268 21
	.loc 1 268 45 is_stmt 0
	lla	a5,.LANCHOR0
	lw	a5,0(a5)
	.loc 1 268 24
	beqz	a5,.L28
	.loc 1 268 51 is_stmt 1 discriminator 1
	mv	a1,s1
	mv	a0,s2
	jalr	a5
.LVL45:
...
.LVL46:
	...
	.loc 1 276 33
	sb	a5,52(s1)
	.loc 1 285 75 is_stmt 1
	.loc 1 291 17
	.loc 1 291 39 is_stmt 0
	lla	a5,rt_interrupt_nest
	lbu	a5,0(a5)
	andi	a5,a5,0xff
	.loc 1 291 20
	bnez	a5,.L30
.LBB24:
	...
	.loc 1 295 28
	beqz	a5,.L31
	.loc 1 295 62 is_stmt 1 discriminator 1
	mv	a0,s2
	jalr	a5
.LVL47:
.L31:
...
.LFE25:
	...
	.comm	rt_current_priority,1,1
	.globl	rt_current_thread
	.comm	rt_thread_ready_priority_group,4,4
	.comm	rt_thread_priority_table,256,4
...
rt_scheduler_lock_nest:
	.zero	2
	.section	.sbss.rt_scheduler_switch_hook,"aw",@nobits
	.align	2
	.set	.LANCHOR1,. + 0
	.type	rt_scheduler_switch_hook, @object
	.size	rt_scheduler_switch_hook, 4
...
.Ldebug_info0:
	...
	.byte	0x5
	.byte	0x3
	.4byte	rt_scheduler_switch_hook
	.byte	0x17
	.4byte	.LASF1178
	.byte	0x1
	.2byte	0x1f0
...
.LASF1068:
	.string	"__on_rt_scheduler_switch_hook(tid) __ON_HOOK_ARGS(rt_scheduler_switch_hook, (tid))"
.LASF135:
...
.LASF1144:
	.string	"rt_scheduler_switch_hook"
.LASF452:
...
.LASF1156:
	.string	"need_insert_from_thread"
.LASF64:
...
.LASF900:
	.string	"RT_ENOENT 12"
.LASF1162:
	.string	"rt_scheduler_switch_sethook"
.LASF236:
...
.LASF1067:
	.string	"__on_rt_scheduler_hook(from,to) __ON_HOOK_ARGS(rt_scheduler_hook, (from, to))"
.LASF649:
...
.LASF1161:
	.string	"highest_priority_thread"
.LASF429:
...
.LASF1180:
	.string	"_scheduler_get_highest_priority_thread"
.LASF446:
