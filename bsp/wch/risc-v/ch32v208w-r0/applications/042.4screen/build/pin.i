# 1 "../../../../../../components/drivers/misc/pin.c"
...
# 1 "../../../../../../components/drivers/misc/pin.c"
# 13 "../../../../../../components/drivers/misc/pin.c"
...
# 14 "../../../../../../components/drivers/misc/pin.c" 2
...
# 78 "../../../../../../components/drivers/misc/pin.c"
int rt_device_pin_register(const char *name, const struct rt_pin_ops *ops, void *user_data)
{
...
# 172 "../../../../../../components/drivers/misc/pin.c" 2
...
# 173 "../../../../../../components/drivers/misc/pin.c" 2
...
# 174 "../../../../../../components/drivers/misc/pin.c" 2

# 1 "../../../../../../components/finsh/msh_parse.h" 1
# 12 "../../../../../../components/finsh/msh_parse.h"
#define MSH_PARSE_H 




# 16 "../../../../../../components/finsh/msh_parse.h"
rt_bool_t msh_isint(char *strvalue);
rt_bool_t msh_ishex(char *strvalue);
int msh_strtohex(char *strvalue);
# 176 "../../../../../../components/drivers/misc/pin.c" 2
...
static rt_base_t _pin_cmd_conv(const char *name)
{
    ...
    format_name[0] = 
# 185 "../../../../../../components/drivers/misc/pin.c" 3
                    __extension__ ({ __typeof__ (
# 185 "../../../../../../components/drivers/misc/pin.c"
                    name[0]
# 185 "../../../../../../components/drivers/misc/pin.c" 3
                    ) __x = (
# 185 "../../../../../../components/drivers/misc/pin.c"
...
# 185 "../../../../../../components/drivers/misc/pin.c"
                                    ;
    format_name[1] = 
# 186 "../../../../../../components/drivers/misc/pin.c" 3
                    __extension__ ({ __typeof__ (
# 186 "../../../../../../components/drivers/misc/pin.c"
                    name[1]
# 186 "../../../../../../components/drivers/misc/pin.c" 3
                    ) __x = (
# 186 "../../../../../../components/drivers/misc/pin.c"
...
const char __fsym_pin_name[] __attribute__((section(".rodata.name"))) = "pin"; const char __fsym_pin_desc[] __attribute__((section(".rodata.name"))) = "pin [option]"; __attribute__((used)) const struct finsh_syscall __fsym_pin __attribute__((section("FSymTab")))= { __fsym_pin_name, __fsym_pin_desc, (syscall_func)&_pin_cmd };;
