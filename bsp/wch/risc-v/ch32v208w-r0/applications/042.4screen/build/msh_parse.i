# 1 "../../../../../../components/finsh/msh_parse.c"
...
# 1 "../../../../../../components/finsh/msh_parse.c"
# 11 "../../../../../../components/finsh/msh_parse.c"
...
# 12 "../../../../../../components/finsh/msh_parse.c" 2
# 1 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\ctype.h" 1 3

#define _CTYPE_H_ 

# 1 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\_ansi.h" 1 3
# 5 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\ctype.h" 2 3
...
# 13 "../../../../../../components/finsh/msh_parse.c" 2

#define forstrloop(str) for (; '\0' != *(str); (str)++)
# 23 "../../../../../../components/finsh/msh_parse.c"

# 23 "../../../../../../components/finsh/msh_parse.c"
rt_bool_t msh_isint(char *strvalue)
{
    if ((0 == strvalue) || ('\0' == strvalue[0]))
    {
        return 0;
    }
    ...
    for (; '\0' != *(strvalue); (strvalue)++)
    {
        if (!
# 35 "../../../../../../components/finsh/msh_parse.c" 3
            ((((__locale_ctype_ptr ())+sizeof(""[
# 35 "../../../../../../components/finsh/msh_parse.c"
            (int)(*strvalue)
# 35 "../../../../../../components/finsh/msh_parse.c" 3
            ]))[(int)(
# 35 "../../../../../../components/finsh/msh_parse.c"
...
# 50 "../../../../../../components/finsh/msh_parse.c"
rt_bool_t msh_ishex(char *strvalue)
{
    ...
    {
        c = 
# 68 "../../../../../../components/finsh/msh_parse.c" 3
           __extension__ ({ __typeof__ (
# 68 "../../../../../../components/finsh/msh_parse.c"
           *strvalue
# 68 "../../../../../../components/finsh/msh_parse.c" 3
           ) __x = (
# 68 "../../../../../../components/finsh/msh_parse.c"
...
# 68 "../../../../../../components/finsh/msh_parse.c"
                             ;
        if (!
# 69 "../../../../../../components/finsh/msh_parse.c" 3
            ((((__locale_ctype_ptr ())+sizeof(""[
# 69 "../../../../../../components/finsh/msh_parse.c"
            c
# 69 "../../../../../../components/finsh/msh_parse.c" 3
            ]))[(int)(
# 69 "../../../../../../components/finsh/msh_parse.c"
...
# 84 "../../../../../../components/finsh/msh_parse.c"
int msh_strtohex(char *strvalue)
{
    ...
    for (; '\0' != *(strvalue); (strvalue)++)
    {
        value *= 16;
        c = 
# 92 "../../../../../../components/finsh/msh_parse.c" 3
           __extension__ ({ __typeof__ (
# 92 "../../../../../../components/finsh/msh_parse.c"
           *strvalue
# 92 "../../../../../../components/finsh/msh_parse.c" 3
           ) __x = (
# 92 "../../../../../../components/finsh/msh_parse.c"
...
# 92 "../../../../../../components/finsh/msh_parse.c"
                             ;
        value += 
# 93 "../../../../../../components/finsh/msh_parse.c" 3
                ((((__locale_ctype_ptr ())+sizeof(""[
# 93 "../../../../../../components/finsh/msh_parse.c"
                c
# 93 "../../../../../../components/finsh/msh_parse.c" 3
                ]))[(int)(
# 93 "../../../../../../components/finsh/msh_parse.c"
