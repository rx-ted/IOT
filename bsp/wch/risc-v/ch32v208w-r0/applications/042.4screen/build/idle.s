...
.LFE16:
	...
	.section	.text.rt_thread_defunct_enqueue,"ax",@progbits
	.align	1
...
.LFE17:
	...
	.section	.text.rt_thread_defunct_dequeue,"ax",@progbits
	.align	1
...
.LFE18:
	...
	.section	.text.rt_defunct_execute,"ax",@progbits
	.align	1
...
.LFE19:
	...
	.section	.text.idle_thread_entry,"ax",@progbits
	.align	1
...
.L33:
.LBB12:
	.loc 1 269 29 is_stmt 0 discriminator 2
	addi	s0,s0,1
.LVL46:
.L32:
...
.L40:
	.cfi_restore_state
	.loc 1 320 9 is_stmt 1 discriminator 3
	mv	a3,s0
	lla	a2,.LC0
	li	a1,8
	addi	a0,sp,8
...
.LVL54:
	...
	lla	s1,.LANCHOR2
	add	s1,s1,a5
	.loc 1 330 17 is_stmt 0 discriminator 3
	slli	a4,s0,9
	.loc 1 322 9 discriminator 3
	li	a7,32
	li	a6,31
...
.LVL56:
	.loc 1 317 25 is_stmt 0 discriminator 3
	addi	s0,s0,1
.LVL57:
	j	.L39
	.cfi_endproc
...
idle_hook_list:
	.zero	16
	.section	.bss.idle_thread,"aw",@nobits
	.align	2
	.set	.LANCHOR2,. + 0
	.type	idle_thread, @object
	.size	idle_thread, 140
idle_thread:
	.zero	140
	.section	.bss.idle_thread_stack,"aw",@nobits
	.align	3
	.set	.LANCHOR3,. + 0
	.type	idle_thread_stack, @object
	.size	idle_thread_stack, 512
idle_thread_stack:
	.zero	512
...
.LC0:
	.string	"tidle%d"
	.section	.sdata._rt_thread_defunct,"aw"
	.align	2
	.set	.LANCHOR1,. + 0
