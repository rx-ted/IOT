# 1 "../../../../../../components/drivers/misc/adc.c"
...
# 1 "../../../../../../components/drivers/misc/adc.c"
# 13 "../../../../../../components/drivers/misc/adc.c"
...
# 14 "../../../../../../components/drivers/misc/adc.c" 2
...
# 15 "../../../../../../components/drivers/misc/adc.c" 2
...
# 29 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\string.h" 3
...
# 17 "../../../../../../components/drivers/misc/adc.c" 2
...
# 18 "../../../../../../components/drivers/misc/adc.c" 2
...
# 22 "../../../../../../components/drivers/misc/adc.c" 2


# 23 "../../../../../../components/drivers/misc/adc.c"
...
# 91 "../../../../../../components/drivers/misc/adc.c"
rt_err_t rt_hw_adc_register(rt_adc_device_t device, const char *name, const struct rt_adc_ops *ops, const void *user_data)
{
    ...
    device->parent.rx_indicate = 0;
    device->parent.tx_complete = 0;
...
rt_int16_t rt_adc_voltage(rt_adc_device_t dev, rt_uint32_t channel)
{
    ...
    if (_adc_control((rt_device_t) dev, RT_ADC_CMD_GET_RESOLUTION, &resolution) != 0)
    {
        goto _voltage_exit;
    }


    if (_adc_control((rt_device_t) dev, RT_ADC_CMD_GET_VREF, &vref) != 0)
    {
        goto _voltage_exit;
    }
...
static int adc(int argc, char **argv)
{
    ...
    rt_err_t result = -1;
    static rt_adc_device_t adc_device = 0;
    char *result_str;
    ...
    if (argc > 1)
    {
        if (!strcmp(argv[1], "probe"))
        {
            if (argc == 3)
            {
                ...
                result_str = (adc_device == 0) ? "failure" : "success";
...
const char __fsym_adc_name[] __attribute__((section(".rodata.name"))) = "adc"; const char __fsym_adc_desc[] __attribute__((section(".rodata.name"))) = "adc [option]"; __attribute__((used)) const struct finsh_syscall __fsym_adc __attribute__((section("FSymTab")))= { __fsym_adc_name, __fsym_adc_desc, (syscall_func)&adc };;
