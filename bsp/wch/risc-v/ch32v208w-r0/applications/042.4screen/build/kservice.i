...
__attribute__((weak)) void rt_hw_us_delay(rt_uint32_t us)
{
    (void) us;
...
__attribute__((weak)) const char *rt_hw_cpu_arch(void)
{
    return "unknown";
}
...
;
# 195 "../../../../../../src/kservice.c"
__attribute__((weak)) void *rt_memset(void *s, int c, rt_ubase_t count)
{
# 205 "../../../../../../src/kservice.c"
...
#define TOO_SMALL(LEN) ((LEN) < LBLOCKSIZE)
    ...
    if (!((count) < (sizeof(rt_ubase_t))) && !((long)s & ((sizeof(rt_ubase_t)) - 1)))
    {
        ...
        for (i = 0; i < (sizeof(rt_ubase_t)); i++)
        {
            *(((unsigned char *)&buffer)+i) = d;
        }

        while (count >= (sizeof(rt_ubase_t)) * 4)
        {
            *aligned_addr++ = buffer;
            *aligned_addr++ = buffer;
            *aligned_addr++ = buffer;
            *aligned_addr++ = buffer;
            count -= 4 * (sizeof(rt_ubase_t));
        }

        while (count >= (sizeof(rt_ubase_t)))
        {
            *aligned_addr++ = buffer;
...
;
# 275 "../../../../../../src/kservice.c"
__attribute__((weak)) void *rt_memcpy(void *dst, const void *src, rt_ubase_t count)
{
# 295 "../../../../../../src/kservice.c"
...
#define TOO_SMALL(LEN) ((LEN) < BIGBLOCKSIZE)
    ...
    if (!((len) < (sizeof (long) << 2)) && !(((long)src_ptr & (sizeof (long) - 1)) | ((long)dst_ptr & (sizeof (long) - 1))))
    {
...
void rt_show_version(void)
{
    ...
    rt_kprintf(" / | \\     %d.%d.%d build %s %s\n",
               (rt_int32_t)5, (rt_int32_t)0, (rt_int32_t)1, "Jun 21 2023", "20:04:30");
...
# 699 "../../../../../../src/kservice.c"
static __inline int divide(unsigned long *n, int base)
...
# 976 "../../../../../../src/kservice.c"
__attribute__((weak)) int rt_vsnprintf(char *buf, rt_size_t size, const char *fmt, va_list args)
{
    ...
    int i = 0, len = 0;
    char *str = 0, *end = 0, c = 0;
    const char *s = 0;

    rt_uint8_t base = 0;
    rt_uint8_t flags = 0;
    rt_uint8_t qualifier = 0;
    rt_int32_t field_width = 0;
...
# 1393 "../../../../../../src/kservice.c"
    ...
    if (new_device == old_device) return 0;
    ...
    if (new_device != 0)
    {
        ...
        rt_device_open(new_device, 0x003 | 0x040);
...
# 1462 "../../../../../../src/kservice.c"
__attribute__((weak)) int rt_kprintf(const char *fmt, ...)
{
    va_list args;
    rt_size_t length = 0;
...
static __inline void _heap_lock_init(void)
{


    rt_mutex_init(&_lock, "heap", 0x01);

}

static __inline rt_base_t _heap_lock(void)
{



    if (rt_thread_self())
        return rt_mutex_take(&_lock, -1);
    else
        return 0;
...
static __inline void _heap_unlock(rt_base_t level)
{
...
static __inline void _smem_info(rt_size_t *total,
...
#define _MEM_INIT(_name,_start,_size) system_heap = rt_smem_init(_name, _start, _size)
...
# 1655 "../../../../../../src/kservice.c"
__attribute__((weak)) void rt_system_heap_init(void *begin_addr, void *end_addr)
{
    rt_ubase_t begin_align = ((((rt_ubase_t)begin_addr) + (8) - 1) & ~((8) - 1));
    rt_ubase_t end_align = (((rt_ubase_t)end_addr) & ~((8) - 1));
...
# 1675 "../../../../../../src/kservice.c"
__attribute__((weak)) void *rt_malloc(rt_size_t size)
{
    rt_base_t level;
    void *ptr;
    ...
    do {if ((rt_malloc_hook) != 0) rt_malloc_hook (ptr, size); } while (0);
    return ptr;
}
;
# 1701 "../../../../../../src/kservice.c"
__attribute__((weak)) void *rt_realloc(void *rmem, rt_size_t newsize)
{
    rt_base_t level;
    void *nptr;
...
;
# 1729 "../../../../../../src/kservice.c"
__attribute__((weak)) void *rt_calloc(rt_size_t count, rt_size_t size)
{
    void *p;
...
__attribute__((weak)) void rt_free(void *rmem)
{
    rt_base_t level;
...
;
# 1776 "../../../../../../src/kservice.c"
__attribute__((weak)) void rt_memory_info(rt_size_t *total,
                            rt_size_t *used,
                            rt_size_t *max_used)
{
    rt_base_t level;
    ...
    level = _heap_lock();
    _smem_info(total, used, max_used);

    _heap_unlock(level);
}
;
# 1829 "../../../../../../src/kservice.c"
__attribute__((weak)) void *rt_malloc_align(rt_size_t size, rt_size_t align)
{
    void *ptr = 0;
    void *align_ptr = 0;
    int uintptr_size = 0;
...
__attribute__((weak)) void rt_free_align(void *ptr)
{
    void *real_ptr = 0;
