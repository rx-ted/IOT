...
.LVL3:
	...
	bnez	a0,.L5
	.loc 1 37 9 is_stmt 1 discriminator 2
	.loc 1 37 14 is_stmt 0 discriminator 2
	addi	s1,s1,4
.LVL4:
...
.LFE26:
	...
	.section	.text.rt_adc_voltage,"ax",@progbits
	.align	1
...
.LVL72:
	...
	.loc 1 210 60 is_stmt 0
	beqz	a0,.L68
	lla	a2,.LC0
.L50:
.LVL73:
	.loc 1 211 17 is_stmt 1 discriminator 4
	lw	a1,8(s2)
	lla	a0,.LC3
	call	rt_kprintf
.LVL74:
...
.LVL79:
	...
	.loc 1 230 60 is_stmt 0
	bnez	a0,.L64
	lla	s3,.LC0
.L55:
.LVL80:
	.loc 1 231 21 is_stmt 1 discriminator 4
	.loc 1 231 73 is_stmt 0 discriminator 4
	lla	a5,.LANCHOR0
	lw	s1,0(a5)
.LVL81:
...
.LVL100:
	...
	.loc 1 255 60 is_stmt 0
	bnez	a0,.L65
	lla	s3,.LC0
.L60:
.LVL101:
	.loc 1 256 21 is_stmt 1 discriminator 4
	.loc 1 256 73 is_stmt 0 discriminator 4
	lla	a5,.LANCHOR0
	lw	s1,0(a5)
.LVL102:
...
.LFE28:
	...
	.section	.rodata.adc.str1.4,"aMS",@progbits,1
	.align	2
.LC0:
	.string	"success"
.LC1:
...
__fsym_adc_name:
	.string	"adc"
	.section	.sbss.adc_device.4029,"aw",@nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	adc_device.4029, @object
	.size	adc_device.4029, 4
adc_device.4029:
	.zero	4
	.section	FSymTab,"a"
	.align	2
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 32 "../../../../../../components/drivers/include/rtdevice.h"
	.byte	0x3
	.byte	0xe
	.byte	0x20
	.byte	0x5
	...
	.4byte	.Ldebug_macro31
	.byte	0x4
	.file 53 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\sys\\string.h"
	.byte	0x3
	.byte	0xaf,0x1
	.byte	0x35
	.byte	0x5
