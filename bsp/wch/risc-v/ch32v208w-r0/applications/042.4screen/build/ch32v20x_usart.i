# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
...
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_usart.h" 2
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c" 2



#define CTLR1_UE_Set ((uint16_t)0x2000)
#define CTLR1_UE_Reset ((uint16_t)0xDFFF)

#define CTLR1_WAKE_Mask ((uint16_t)0xF7FF)

#define CTLR1_RWU_Set ((uint16_t)0x0002)
#define CTLR1_RWU_Reset ((uint16_t)0xFFFD)
#define CTLR1_SBK_Set ((uint16_t)0x0001)
#define CTLR1_CLEAR_Mask ((uint16_t)0xE9F3)
#define CTLR2_Address_Mask ((uint16_t)0xFFF0)

#define CTLR2_LINEN_Set ((uint16_t)0x4000)
#define CTLR2_LINEN_Reset ((uint16_t)0xBFFF)

#define CTLR2_LBDL_Mask ((uint16_t)0xFFDF)
#define CTLR2_STOP_CLEAR_Mask ((uint16_t)0xCFFF)
#define CTLR2_CLOCK_CLEAR_Mask ((uint16_t)0xF0FF)

#define CTLR3_SCEN_Set ((uint16_t)0x0020)
#define CTLR3_SCEN_Reset ((uint16_t)0xFFDF)

#define CTLR3_NACK_Set ((uint16_t)0x0010)
#define CTLR3_NACK_Reset ((uint16_t)0xFFEF)

#define CTLR3_HDSEL_Set ((uint16_t)0x0008)
#define CTLR3_HDSEL_Reset ((uint16_t)0xFFF7)

#define CTLR3_IRLP_Mask ((uint16_t)0xFFFB)
#define CTLR3_CLEAR_Mask ((uint16_t)0xFCFF)

#define CTLR3_IREN_Set ((uint16_t)0x0002)
#define CTLR3_IREN_Reset ((uint16_t)0xFFFD)
#define GPR_LSB_Mask ((uint16_t)0x00FF)
#define GPR_MSB_Mask ((uint16_t)0xFF00)
#define IT_Mask ((uint16_t)0x001F)


#define CTLR1_OVER8_Set ((uint16_t)0x8000)
#define CTLR1_OVER8_Reset ((uint16_t)0x7FFF)


#define CTLR3_ONEBITE_Set ((uint16_t)0x0800)
#define CTLR3_ONEBITE_Reset ((uint16_t)0xF7FF)
# 68 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_DeInit(USART_TypeDef *USARTx)
{
...
# 105 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_Init(USART_TypeDef *USARTx, USART_InitTypeDef *USART_InitStruct)
{
    ...
    if((USARTx->CTLR1 & ((uint16_t)0x8000)) != 0)
    {
...
# 178 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_StructInit(USART_InitTypeDef *USART_InitStruct)
{
...
# 201 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClockInit(USART_TypeDef *USARTx, USART_ClockInitTypeDef *USART_ClockInitStruct)
{
...
# 222 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClockStructInit(USART_ClockInitTypeDef *USART_ClockInitStruct)
{
...
# 241 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_Cmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR1 |= ((uint16_t)0x2000);
    }
    else
    {
        USARTx->CTLR1 &= ((uint16_t)0xDFFF);
    }
}
# 273 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ITConfig(USART_TypeDef *USARTx, uint16_t USART_IT, FunctionalState NewState)
{
...
# 323 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_DMACmd(USART_TypeDef *USARTx, uint16_t USART_DMAReq, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 345 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SetAddress(USART_TypeDef *USARTx, uint8_t USART_Address)
{
    USARTx->CTLR2 &= ((uint16_t)0xFFF0);
    USARTx->CTLR2 |= USART_Address;
}
# 363 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_WakeUpConfig(USART_TypeDef *USARTx, uint16_t USART_WakeUp)
{
    USARTx->CTLR1 &= ((uint16_t)0xF7FF);
    USARTx->CTLR1 |= USART_WakeUp;
}
# 379 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ReceiverWakeUpCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR1 |= ((uint16_t)0x0002);
    }
    else
    {
        USARTx->CTLR1 &= ((uint16_t)0xFFFD);
    }
}
# 403 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_LINBreakDetectLengthConfig(USART_TypeDef *USARTx, uint16_t USART_LINBreakDetectLength)
{
    USARTx->CTLR2 &= ((uint16_t)0xFFDF);
    USARTx->CTLR2 |= USART_LINBreakDetectLength;
}
# 419 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_LINCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR2 |= ((uint16_t)0x4000);
    }
    else
    {
        USARTx->CTLR2 &= ((uint16_t)0xBFFF);
    }
}
# 441 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SendData(USART_TypeDef *USARTx, uint16_t Data)
{
    USARTx->DATAR = (Data & (uint16_t)0x01FF);
}
# 455 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
uint16_t USART_ReceiveData(USART_TypeDef *USARTx)
{
    return (uint16_t)(USARTx->DATAR & (uint16_t)0x01FF);
}
# 469 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SendBreak(USART_TypeDef *USARTx)
{
    USARTx->CTLR1 |= ((uint16_t)0x0001);
}
# 484 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SetGuardTime(USART_TypeDef *USARTx, uint8_t USART_GuardTime)
{
    USARTx->GPR &= ((uint16_t)0x00FF);
    USARTx->GPR |= (uint16_t)((uint16_t)USART_GuardTime << 0x08);
}
# 500 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SetPrescaler(USART_TypeDef *USARTx, uint8_t USART_Prescaler)
{
    USARTx->GPR &= ((uint16_t)0xFF00);
    USARTx->GPR |= USART_Prescaler;
}
# 516 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SmartCardCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR3 |= ((uint16_t)0x0020);
    }
    else
    {
        USARTx->CTLR3 &= ((uint16_t)0xFFDF);
    }
}
# 538 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_SmartCardNACKCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR3 |= ((uint16_t)0x0010);
    }
    else
    {
        USARTx->CTLR3 &= ((uint16_t)0xFFEF);
    }
}
# 560 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_HalfDuplexCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR3 |= ((uint16_t)0x0008);
    }
    else
    {
        USARTx->CTLR3 &= ((uint16_t)0xFFF7);
    }
}
# 582 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_OverSampling8Cmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR1 |= ((uint16_t)0x8000);
    }
    else
    {
        USARTx->CTLR1 &= ((uint16_t)0x7FFF);
    }
}
# 604 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_OneBitMethodCmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR3 |= ((uint16_t)0x0800);
    }
    else
    {
        USARTx->CTLR3 &= ((uint16_t)0xF7FF);
    }
}
# 628 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_IrDAConfig(USART_TypeDef *USARTx, uint16_t USART_IrDAMode)
{
    USARTx->CTLR3 &= ((uint16_t)0xFFFB);
    USARTx->CTLR3 |= USART_IrDAMode;
}
# 644 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_IrDACmd(USART_TypeDef *USARTx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        USARTx->CTLR3 |= ((uint16_t)0x0002);
    }
    else
    {
        USARTx->CTLR3 &= ((uint16_t)0xFFFD);
    }
}
# 676 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
FlagStatus USART_GetFlagStatus(USART_TypeDef *USARTx, uint16_t USART_FLAG)
{
...
# 709 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClearFlag(USART_TypeDef *USARTx, uint16_t USART_FLAG)
{
...
# 739 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
ITStatus USART_GetITStatus(USART_TypeDef *USARTx, uint16_t USART_IT)
{
...
# 795 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_usart.c"
void USART_ClearITPendingBit(USART_TypeDef *USARTx, uint16_t USART_IT)
{
