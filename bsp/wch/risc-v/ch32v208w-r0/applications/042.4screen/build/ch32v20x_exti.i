# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
...
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_exti.h" 2
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c" 2


#define EXTI_LINENONE ((uint32_t)0x00000)
# 23 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
void EXTI_DeInit(void)
{
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTENR = 0x00000000;
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->EVENR = 0x00000000;
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTENR = 0x00000000;
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTENR = 0x00000000;
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTFR = 0x000FFFFF;
}
# 42 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
void EXTI_Init(EXTI_InitTypeDef *EXTI_InitStruct)
{
    uint32_t tmp = 0;
    ...
    {
        ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTENR &= ~EXTI_InitStruct->EXTI_Line;
        ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->EVENR &= ~EXTI_InitStruct->EXTI_Line;
        tmp += EXTI_InitStruct->EXTI_Mode;
        *(volatile uint32_t *)tmp |= EXTI_InitStruct->EXTI_Line;
        ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->RTENR &= ~EXTI_InitStruct->EXTI_Line;
        ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->FTENR &= ~EXTI_InitStruct->EXTI_Line;
...
# 83 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
void EXTI_StructInit(EXTI_InitTypeDef *EXTI_InitStruct)
{
...
# 100 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
void EXTI_GenerateSWInterrupt(uint32_t EXTI_Line)
{
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->SWIEVR |= EXTI_Line;
}
# 114 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
FlagStatus EXTI_GetFlagStatus(uint32_t EXTI_Line)
{
    FlagStatus bitstatus = RESET;
    if((((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTFR & EXTI_Line) != (uint32_t)RESET)
    {
        bitstatus = SET;
    }
    else
...
# 137 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
void EXTI_ClearFlag(uint32_t EXTI_Line)
{
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTFR = EXTI_Line;
}
# 151 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
ITStatus EXTI_GetITStatus(uint32_t EXTI_Line)
{
    ITStatus bitstatus = RESET;
    uint32_t enablestatus = 0;

    enablestatus = ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTENR & EXTI_Line;
    if(((((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTFR & EXTI_Line) != (uint32_t)RESET) && (enablestatus != (uint32_t)RESET))
    {
        bitstatus = SET;
    }
    else
...
# 177 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_exti.c"
void EXTI_ClearITPendingBit(uint32_t EXTI_Line)
{
    ((EXTI_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x0400))->INTFR = EXTI_Line;
}
