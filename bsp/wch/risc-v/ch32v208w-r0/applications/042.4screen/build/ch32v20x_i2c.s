...
I2C_DeInit:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
	.loc 1 101 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-16
...
.LVL44:
	...
	.loc 1 204 29 is_stmt 0
	sh	zero,10(a0)
	.loc 1 205 5 is_stmt 1
	.loc 1 205 45 is_stmt 0
	li	a5,16384
	sh	a5,12(a0)
	.loc 1 206 1
	ret
...
.LVL104:
	...
	.loc 1 853 14 is_stmt 0
	sw	a0,8(sp)
	.loc 1 854 5 is_stmt 1
	.loc 1 854 23 is_stmt 0
	srli	a5,a1,28
	.loc 1 854 12
	sw	a5,12(sp)
	.loc 1 855 5 is_stmt 1
	.loc 1 855 14 is_stmt 0
	li	a5,16777216
	addi	a5,a5,-1
	and	a1,a1,a5
.LVL105:
...
.LVL112:
	.loc 1 898 5
	.loc 1 900 5
	.loc 1 900 13 is_stmt 0
	li	a5,16777216
	addi	a5,a5,-1
	and	a1,a1,a5
.LVL113:
	.loc 1 901 5 is_stmt 1
	.loc 1 901 19 is_stmt 0
	not	a1,a1
.LVL114:
	slli	a1,a1,16
.LVL115:
...
.Letext0:
	...
	.file 5 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_rcc.h"
	...
	.file 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/bmsis/include/system_ch32v20x.h"
	.file 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_i2c.h"
...
.Ldebug_macro46:
	...
	.4byte	.LASF5108
	.byte	0
	.section	.debug_macro,"G",@progbits,wm4.ch32v20x_i2c.h.43.98fa2b1ce931c1c54535679b9f47dbb7,comdat
.Ldebug_macro47:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF5203:
	.string	"CTLR1_PEC_Reset ((uint16_t)0xEFFF)"
.LASF4753:
	.string	"_SIZET_ "
.LASF3331:
...
.LASF5410:
	.string	"I2C_FastModeDutyCycleConfig"
.LASF2841:
...
.LASF5210:
	.string	"CTLR1_CLEAR_Mask ((uint16_t)0xFBF5)"
.LASF4552:
...
.LASF5191:
	.string	"CTLR1_PE_Reset ((uint16_t)0xFFFE)"
.LASF2627:
...
.LASF5454:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_i2c.c"
.LASF4199:
...
.LASF5202:
	.string	"CTLR1_PEC_Set ((uint16_t)0x1000)"
.LASF4952:
...
.LASF5205:
	.string	"CTLR1_ENPEC_Reset ((uint16_t)0xFFDF)"
.LASF1846:
...
.LASF5192:
	.string	"CTLR1_START_Set ((uint16_t)0x0100)"
.LASF254:
...
.LASF5196:
	.string	"CTLR1_ACK_Set ((uint16_t)0x0400)"
.LASF702:
...
.LASF5206:
	.string	"CTLR1_ENARP_Set ((uint16_t)0x0010)"
.LASF2746:
...
.LASF5209:
	.string	"CTLR1_NOSTRETCH_Reset ((uint16_t)0xFF7F)"
.LASF160:
...
.LASF5199:
	.string	"CTLR1_ENGC_Reset ((uint16_t)0xFFBF)"
.LASF4319:
...
.LASF5193:
	.string	"CTLR1_START_Reset ((uint16_t)0xFEFF)"
.LASF2505:
...
.LASF5194:
	.string	"CTLR1_STOP_Set ((uint16_t)0x0200)"
.LASF5237:
	.string	"NoREADY"
.LASF4317:
...
.LASF331:
	.string	"INT8_MAX"
.LASF5211:
	.string	"CTLR2_DMAEN_Set ((uint16_t)0x0800)"
.LASF750:
...
.LASF5200:
	.string	"CTLR1_SWRST_Set ((uint16_t)0x8000)"
.LASF1447:
...
.LASF314:
	.string	"USE_M_TIME 1"
.LASF5221:
	.string	"CKCFGR_FS_Set ((uint16_t)0x8000)"
.LASF293:
...
.LASF5220:
	.string	"OADDR2_ADD2_Reset ((uint16_t)0xFF01)"
.LASF101:
...
.LASF5217:
	.string	"OADDR1_ADD0_Reset ((uint16_t)0xFFFE)"
.LASF4651:
...
.LASF5208:
	.string	"CTLR1_NOSTRETCH_Set ((uint16_t)0x0080)"
.LASF2700:
...
.LASF5214:
	.string	"CTLR2_LAST_Reset ((uint16_t)0xEFFF)"
.LASF2103:
...
.LASF5222:
	.string	"CKCFGR_CCR_Set ((uint16_t)0x0FFF)"
.LASF5399:
	.string	"I2C_GetITStatus"
.LASF2096:
...
.LASF5215:
	.string	"CTLR2_FREQ_Reset ((uint16_t)0xFFC0)"
.LASF61:
...
.LASF5422:
	.string	"I2C_NACKPosition"
.LASF5216:
	.string	"OADDR1_ADD0_Set ((uint16_t)0x0001)"
.LASF1747:
...
.LASF5219:
	.string	"OADDR2_ENDUAL_Reset ((uint16_t)0xFFFE)"
.LASF867:
...
.LASF5218:
	.string	"OADDR2_ENDUAL_Set ((uint16_t)0x0001)"
.LASF1506:
...
.LASF5223:
	.string	"FLAG_Mask ((uint32_t)0x00FFFFFF)"
.LASF1437:
...
.LASF5330:
	.string	"_stderr"
.LASF5389:
	.string	"I2C_AcknowledgedAddress"
.LASF2020:
...
.LASF5197:
	.string	"CTLR1_ACK_Reset ((uint16_t)0xFBFF)"
.LASF1176:
...
.LASF5190:
	.string	"CTLR1_PE_Set ((uint16_t)0x0001)"
.LASF4890:
...
.LASF5198:
	.string	"CTLR1_ENGC_Set ((uint16_t)0x0040)"
.LASF3283:
...
.LASF5224:
	.string	"ITEN_Mask ((uint32_t)0x07000000)"
.LASF5023:
...
.LASF5195:
	.string	"CTLR1_STOP_Reset ((uint16_t)0xFDFF)"
.LASF1643:
...
.LASF5213:
	.string	"CTLR2_LAST_Set ((uint16_t)0x1000)"
.LASF3284:
...
.LASF5201:
	.string	"CTLR1_SWRST_Reset ((uint16_t)0x7FFF)"
.LASF2695:
