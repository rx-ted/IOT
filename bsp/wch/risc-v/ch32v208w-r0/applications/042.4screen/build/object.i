...
static struct rt_object_information _object_container[RT_Object_Info_Unknown] =
{
    ...
    {RT_Object_Class_Thread, {&(_object_container[RT_Object_Info_Thread].object_list), &(_object_container[RT_Object_Info_Thread].object_list)}, sizeof(struct rt_thread)},


    {RT_Object_Class_Semaphore, {&(_object_container[RT_Object_Info_Semaphore].object_list), &(_object_container[RT_Object_Info_Semaphore].object_list)}, sizeof(struct rt_semaphore)},



    {RT_Object_Class_Mutex, {&(_object_container[RT_Object_Info_Mutex].object_list), &(_object_container[RT_Object_Info_Mutex].object_list)}, sizeof(struct rt_mutex)},



    {RT_Object_Class_Event, {&(_object_container[RT_Object_Info_Event].object_list), &(_object_container[RT_Object_Info_Event].object_list)}, sizeof(struct rt_event)},



    {RT_Object_Class_MailBox, {&(_object_container[RT_Object_Info_MailBox].object_list), &(_object_container[RT_Object_Info_MailBox].object_list)}, sizeof(struct rt_mailbox)},



    {RT_Object_Class_MessageQueue, {&(_object_container[RT_Object_Info_MessageQueue].object_list), &(_object_container[RT_Object_Info_MessageQueue].object_list)}, sizeof(struct rt_messagequeue)},
# 120 "../../../../../../src/object.c"
    {RT_Object_Class_Device, {&(_object_container[RT_Object_Info_Device].object_list), &(_object_container[RT_Object_Info_Device].object_list)}, sizeof(struct rt_device)},


    {RT_Object_Class_Timer, {&(_object_container[RT_Object_Info_Timer].object_list), &(_object_container[RT_Object_Info_Timer].object_list)}, sizeof(struct rt_timer)},
    ...
    {RT_Object_Class_Memory, {&(_object_container[RT_Object_Info_Memory].object_list), &(_object_container[RT_Object_Info_Memory].object_list)}, sizeof(struct rt_memory)},
...
rt_object_t rt_object_find(const char *name, rt_uint8_t type)
{
    ...
    if ((name == 0) || (information == 0)) return 0;
...
rt_object_t rt_custom_object_create(const char *name, void *data, rt_err_t (*data_destroy)(void *))
{
    struct rt_custom_object *cobj = 0;
