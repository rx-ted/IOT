# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
...
# 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
# 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
...
# 19 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_dma.h" 2
...
# 11 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c" 2
...
# 40 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_DeInit(DMA_Channel_TypeDef *DMAy_Channelx)
{
    DMAy_Channelx->CFGR &= (uint16_t)(~((uint16_t)0x0001));
    ...
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x00000004) | ((uint32_t)0x00000008)));
    }
    else if(DMAy_Channelx == ((DMA_Channel_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x001C)))
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x00000010) | ((uint32_t)0x00000020) | ((uint32_t)0x00000040) | ((uint32_t)0x00000080)));
    }
    else if(DMAy_Channelx == ((DMA_Channel_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0030)))
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x00000100) | ((uint32_t)0x00000200) | ((uint32_t)0x00000400) | ((uint32_t)0x00000800)));
    }
    else if(DMAy_Channelx == ((DMA_Channel_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0044)))
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x00001000) | ((uint32_t)0x00002000) | ((uint32_t)0x00004000) | ((uint32_t)0x00008000)));
    }
    else if(DMAy_Channelx == ((DMA_Channel_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0058)))
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x00010000) | ((uint32_t)0x00020000) | ((uint32_t)0x00040000) | ((uint32_t)0x00080000)));
    }
    else if(DMAy_Channelx == ((DMA_Channel_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x006C)))
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x00100000) | ((uint32_t)0x00200000) | ((uint32_t)0x00400000) | ((uint32_t)0x00800000)));
    }
    else if(DMAy_Channelx == ((DMA_Channel_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0080)))
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x01000000) | ((uint32_t)0x02000000) | ((uint32_t)0x04000000) | ((uint32_t)0x08000000)));
    }
    else if(DMAy_Channelx == ((DMA_Channel_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0094)))
    {
        ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR |= ((uint32_t)(((uint32_t)0x00000001) | ((uint32_t)0x00000002) | ((uint32_t)0x00000004) | ((uint32_t)0x00000008)));
    }
}
# 94 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_Init(DMA_Channel_TypeDef *DMAy_Channelx, DMA_InitTypeDef *DMA_InitStruct)
{
    uint32_t tmpreg = 0;
...
# 123 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_StructInit(DMA_InitTypeDef *DMA_InitStruct)
{
...
# 149 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_Cmd(DMA_Channel_TypeDef *DMAy_Channelx, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
        DMAy_Channelx->CFGR |= ((uint16_t)0x0001);
    }
    else
    {
        DMAy_Channelx->CFGR &= (uint16_t)(~((uint16_t)0x0001));
...
# 177 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_ITConfig(DMA_Channel_TypeDef *DMAy_Channelx, uint32_t DMA_IT, FunctionalState NewState)
{
    if(NewState != DISABLE)
    {
...
# 201 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_SetCurrDataCounter(DMA_Channel_TypeDef *DMAy_Channelx, uint16_t DataNumber)
{
    DMAy_Channelx->CNTR = DataNumber;
}
# 218 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
uint16_t DMA_GetCurrDataCounter(DMA_Channel_TypeDef *DMAy_Channelx)
{
    return ((uint16_t)(DMAy_Channelx->CNTR));
}
# 264 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
FlagStatus DMA_GetFlagStatus(uint32_t DMAy_FLAG)
{
    FlagStatus bitstatus = RESET;
    uint32_t tmpreg = 0;

    tmpreg = ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFR;
...
# 323 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_ClearFlag(uint32_t DMAy_FLAG)
{
    ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR = DMAy_FLAG;
}
# 369 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
ITStatus DMA_GetITStatus(uint32_t DMAy_IT)
{
...
# 427 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_dma.c"
void DMA_ClearITPendingBit(uint32_t DMAy_IT)
{
    ((DMA_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x0000))->INTFCR = DMAy_IT;
}
