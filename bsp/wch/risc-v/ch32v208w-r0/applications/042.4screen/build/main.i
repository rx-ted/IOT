...
# 16 "../../../../../../components/drivers/include/drivers/pin.h" 2
...
#define GPIO_PORT_PC GPIOC_BASE
...
int main(void)
{
    ...
    ((RCC_TypeDef *)((((uint32_t)0x40000000) + 0x20000) + 0x1000))->APB2PCENR |= ((uint32_t)0x00000001);

    ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CFGLR &= ~(((uint32_t)0x00000003) | ((uint32_t)0x00000030) | ((uint32_t)0x0000000C) | ((uint32_t)0x000000C0));
    ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CFGLR |= ((uint32_t)0x00000003) | ((uint32_t)0x00000030);
    while (1)
    {
        ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSHR = 0xa;
        rt_thread_mdelay(1000);

        ((GPIO_TypeDef *)((((uint32_t)0x40000000) + 0x10000) + 0x1000))->BSHR = 0xF0000;
