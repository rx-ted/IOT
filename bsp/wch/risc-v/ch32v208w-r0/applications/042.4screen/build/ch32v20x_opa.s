...
.Ltext0:
	...
	.section	.text.OPA_DeInit,"ax",@progbits
	.align	1
	.globl	OPA_DeInit
	.type	OPA_DeInit, @function
OPA_DeInit:
.LFB18:
	.file 1 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_opa.c"
	.loc 1 24 1
	.cfi_startproc
	.loc 1 25 5
	.loc 1 25 72 is_stmt 0
	li	a5,1073889280
	sw	zero,-2044(a5)
	.loc 1 26 1
	ret
...
.LFE18:
	...
	.section	.text.OPA_Init,"ax",@progbits
	.align	1
	.globl	OPA_Init
...
.LFE19:
	...
	.section	.text.OPA_StructInit,"ax",@progbits
	.align	1
...
.LFE20:
	...
	.section	.text.OPA_Cmd,"ax",@progbits
	.align	1
	.globl	OPA_Cmd
...
.Letext0:
	...
	.file 10 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_opa.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 48 "../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/include/ch32v20x_misc.h"
	.byte	0x3
	.byte	0x20
	.byte	0x30
	.byte	0x7
...
.LASF5349:
	.string	"../../../../../../bsp/wch/risc-v/Libraries/ch32v20x_libraries/ch32v208_hal/source/ch32v20x_opa.c"
.LASF3126:
