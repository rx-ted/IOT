...
.Ltext0:
	...
	.section	.text.rt_hw_interrupt_handle,"ax",@progbits
	.align	1
	.weak	rt_hw_interrupt_handle
	.type	rt_hw_interrupt_handle, @function
rt_hw_interrupt_handle:
.LFB15:
	.file 1 "../../../../../../libcpu/risc-v/common/trap_common.c"
	.loc 1 18 1
	.cfi_startproc
.LVL0:
	addi	sp,sp,-16
...
.L4:
	...
	li	a5,31
	bgt	a4,a5,.L6
	.loc 1 32 9 is_stmt 1 discriminator 3
	.loc 1 32 36 is_stmt 0 discriminator 3
	slli	a3,a4,3
	lla	a5,.LANCHOR0
	add	a5,a5,a3
	lla	a3,rt_hw_interrupt_handle
	sw	a3,0(a5)
	.loc 1 33 9 is_stmt 1 discriminator 3
	.loc 1 33 34 is_stmt 0 discriminator 3
	sw	zero,4(a5)
...
.LVL8:
	...
	.loc 1 58 43 is_stmt 0
	lla	a4,.LANCHOR0
	add	a5,a4,a3
	sw	a1,0(a5)
	.loc 1 59 13 is_stmt 1
	.loc 1 59 41 is_stmt 0
	sw	a2,4(a5)
	ret
.LVL9:
.L9:
...
.LFE17:
	...
	.section	.text.rt_show_stack_frame,"ax",@progbits
	.align	1
...
.LBB2:
	...
	.loc 1 94 64
 #APP
# 94 "../../../../../../libcpu/risc-v/common/trap_common.c" 1
	csrr a1, 0x300
# 0 "" 2
.LVL13:
	.loc 1 94 114
...
.LFE19:
	...
	.section	.text.rt_rv32_system_irq_handler,"ax",@progbits
	.align	1
...
.LBB3:
	...
	.loc 1 73 52
 #APP
# 73 "../../../../../../libcpu/risc-v/common/trap_common.c" 1
	csrr a5, 0x340
# 0 "" 2
.LVL31:
	.loc 1 73 102
...
.LFE18:
	...
	.section	.bss.rv32irq_table,"aw",@nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	rv32irq_table, @object
	.size	rv32irq_table, 256
rv32irq_table:
	.zero	256
	.section	.rodata.rt_hw_interrupt_handle.str1.4,"aMS",@progbits,1
	.align	2
.LC0:
	.string	"UN-handled interrupt %d occurred!!!\n"
	.section	.rodata.rt_show_stack_frame.str1.4,"aMS",@progbits,1
	.align	2
.LC1:
	.string	"Stack frame:\r\n----------------------------------------\r\n"
	.zero	3
...
.LC18:
	.string	"t6      : 0x%08x\r\n"
	.section	.sbss.s_stack_frame,"aw",@nobits
	.align	2
	.set	.LANCHOR1,. + 0
	.type	s_stack_frame, @object
	.size	s_stack_frame, 4
s_stack_frame:
	.zero	4
	.text
.Letext0:
	...
	.file 5 "../../../../../../include/rthw.h"
	.file 6 "../../../../../../libcpu/risc-v/common/rt_hw_stack_frame.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.file 29 "../../../../../../libcpu/risc-v/common/riscv-ops.h"
	.byte	0x3
	.byte	0x3
	.byte	0x1d
	.byte	0x7
	...
	.byte	0xc
	.4byte	.LASF1072
	.file 30 "../../../../../../libcpu/risc-v/common/cpuport.h"
	.byte	0x3
	.byte	0xe
	.byte	0x1e
	.byte	0x7
...
.LASF1128:
	.string	"../../../../../../libcpu/risc-v/common/trap_common.c"
.LASF44:
