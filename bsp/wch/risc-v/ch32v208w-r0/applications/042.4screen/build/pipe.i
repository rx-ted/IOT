# 1 "../../../../../../components/drivers/ipc/pipe.c"
...
# 1 "../../../../../../components/drivers/ipc/pipe.c"
# 11 "../../../../../../components/drivers/ipc/pipe.c"
# 1 "../../../../../../include/rthw.h" 1
# 19 "../../../../../../include/rthw.h"
#define __RT_HW_H__ 
...
#define rt_hw_dmb() 
#define rt_hw_dsb() 
# 12 "../../../../../../components/drivers/ipc/pipe.c" 2
...
# 13 "../../../../../../components/drivers/ipc/pipe.c" 2
...
# 15 "../../../../../../components/drivers/ipc/pipe.c" 2
# 396 "../../../../../../components/drivers/ipc/pipe.c"
...
# 433 "../../../../../../components/drivers/ipc/pipe.c"
...
# 465 "../../../../../../components/drivers/ipc/pipe.c"
rt_ssize_t rt_pipe_read(rt_device_t device, rt_off_t pos, void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 473 "../../../../../../components/drivers/ipc/pipe.c" 3
                     22
# 473 "../../../../../../components/drivers/ipc/pipe.c"
                           );
        return 0;
    }
    if (count == 0)
...
# 513 "../../../../../../components/drivers/ipc/pipe.c"
rt_ssize_t rt_pipe_write(rt_device_t device, rt_off_t pos, const void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 521 "../../../../../../components/drivers/ipc/pipe.c" 3
                     22
# 521 "../../../../../../components/drivers/ipc/pipe.c"
                           );
        return 0;
    }
    if (count == 0)
...
# 558 "../../../../../../components/drivers/ipc/pipe.c"
rt_err_t rt_pipe_control(rt_device_t dev, int cmd, void *args)
{
    return 0;
}
# 587 "../../../../../../components/drivers/ipc/pipe.c"
rt_pipe_t *rt_pipe_create(const char *name, int bufsz)
{
    rt_pipe_t *pipe;
    rt_device_t dev;
...
# 652 "../../../../../../components/drivers/ipc/pipe.c"
int rt_pipe_delete(const char *name)
{
    int result = 0;
    rt_device_t device;
    ...
    if (device)
    {
        ...
        {
            result = -
# 682 "../../../../../../components/drivers/ipc/pipe.c" 3
                     19
# 682 "../../../../../../components/drivers/ipc/pipe.c"
                           ;
        }
    }
    else
    {
        result = -
# 687 "../../../../../../components/drivers/ipc/pipe.c" 3
                 19
# 687 "../../../../../../components/drivers/ipc/pipe.c"
                       ;
    }
