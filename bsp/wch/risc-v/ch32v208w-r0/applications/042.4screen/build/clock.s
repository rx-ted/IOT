...
.Ltext0:
	...
	.section	.text.rt_tick_sethook,"ax",@progbits
	.align	1
	.globl	rt_tick_sethook
	.type	rt_tick_sethook, @function
rt_tick_sethook:
.LFB15:
	.file 1 "../../../../../../src/clock.c"
	.loc 1 49 1
...
.LVL0:
	...
	.cfi_endproc
.LFE15:
	.size	rt_tick_sethook, .-rt_tick_sethook
...
.LFB18:
	...
	.loc 1 96 12
	beqz	a5,.L6
	.loc 1 96 34 is_stmt 1 discriminator 1
	jalr	a5
.LVL5:
.L6:
	.loc 1 98 5
...
.LFE19:
	...
	.section	.text.rt_tick_get_millisecond,"ax",@progbits
	.align	1
	.weak	rt_tick_get_millisecond
	.type	rt_tick_get_millisecond, @function
...
.LVL23:
	...
	.cfi_endproc
.LFE20:
	.size	rt_tick_get_millisecond, .-rt_tick_get_millisecond
...
rt_tick:
	.zero	4
	.section	.sbss.rt_tick_hook,"aw",@nobits
	.align	2
	.set	.LANCHOR0,. + 0
	.type	rt_tick_hook, @object
	.size	rt_tick_hook, 4
rt_tick_hook:
	.zero	4
	.text
...
.LASF1067:
	.string	"__on_rt_tick_hook() __ON_HOOK_ARGS(rt_tick_hook, ())"
.LASF723:
...
.LASF1135:
	.string	"rt_tick_get_millisecond"
.LASF751:
