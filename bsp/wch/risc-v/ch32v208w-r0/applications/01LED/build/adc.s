...
_adc_read:
.LFB21:
	.file 1 "../../../../../../components/drivers/misc/adc.c"
	.loc 1 24 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L9:
	...
	addi	a5,a5,-1277
	bne	a4,a5,.L10
	.loc 1 56 53 discriminator 1
	lw	a5,-24(s0)
	lw	a5,68(a5)
	.loc 1 56 58 discriminator 1
	lw	a5,8(a5)
	.loc 1 56 47 discriminator 1
	beqz	a5,.L10
	.loc 1 56 75 discriminator 2
	lw	a5,-44(s0)
	beqz	a5,.L10
.LBB2:
	.loc 1 58 36
...
.L10:
	...
	addi	a5,a5,-1276
	bne	a4,a5,.L8
	.loc 1 66 47 discriminator 1
	lw	a5,-24(s0)
	lw	a5,68(a5)
	.loc 1 66 52 discriminator 1
	lw	a5,12(a5)
	.loc 1 66 41 discriminator 1
	beqz	a5,.L8
	.loc 1 66 63 discriminator 2
	lw	a5,-44(s0)
	beqz	a5,.L8
.LBB3:
	.loc 1 68 31
...
.LFE26:
	...
	.align	1
	.globl	rt_adc_voltage
	.type	rt_adc_voltage, @function
rt_adc_voltage:
.LFB27:
	.loc 1 166 1
	.cfi_startproc
...
.L28:
	...
	.cfi_endproc
.LFE27:
	.size	rt_adc_voltage, .-rt_adc_voltage
	.section	.rodata
	.align	2
.LC0:
	.string	"probe"
...
.LC3:
	...
	.align	2
.LC4:
	.string	"adc probe <device name>   - probe adc by name\n"
	.align	2
.LC5:
	.string	"Please using 'adc probe <device name>' first\n"
	.align	2
.LC6:
	.string	"enable"
	.align	2
.LC7:
	.string	"%s channel %d enables %s \n"
	.align	2
.LC8:
	.string	"adc enable <channel>   - enable adc channel\n"
	.align	2
.LC9:
	.string	"read"
	.align	2
.LC10:
	.string	"%s channel %d  read value is 0x%08X \n"
	.align	2
.LC11:
	.string	"adc read <channel>     - read adc value on the channel\n"
	.align	2
.LC12:
	.string	"disable"
	.align	2
.LC13:
	.string	"%s channel %d disable %s \n"
	.align	2
.LC14:
	.string	"adc disable <channel>  - disable adc channel\n"
	.align	2
.LC15:
	.string	"voltage"
	.align	2
.LC16:
	.string	"%s channel %d voltage is %d.%03dV \n"
	.align	2
.LC17:
	.string	"adc convert voltage <channel> \n"
	.align	2
.LC18:
	.string	"Unknown command. Please enter 'adc' for help\n"
	.align	2
.LC19:
	.string	"Usage: \n"
	.align	2
...
.LFB28:
	...
	.loc 1 210 60
	bnez	a5,.L37
	.loc 1 210 60 is_stmt 0 discriminator 1
	lla	a5,.LC1
	j	.L38
.L37:
	.loc 1 210 60 discriminator 2
	lla	a5,.LC2
.L38:
	.loc 1 210 28 is_stmt 1 discriminator 4
	sw	a5,-32(s0)
	.loc 1 211 50 discriminator 4
	lw	a5,-40(s0)
	addi	a5,a5,8
	.loc 1 211 17 discriminator 4
	lw	a5,0(a5)
	lw	a2,-32(s0)
	mv	a1,a5
	lla	a0,.LC3
...
.L41:
	...
	lw	a5,-28(s0)
	bnez	a5,.L45
	.loc 1 230 60 is_stmt 0 discriminator 1
	lla	a5,.LC2
	j	.L46
.L45:
	.loc 1 230 60 discriminator 2
	lla	a5,.LC1
.L46:
	.loc 1 230 32 is_stmt 1 discriminator 4
	sw	a5,-32(s0)
	.loc 1 231 73 discriminator 4
	lla	a5,adc_device.4029
	lw	a5,0(a5)
	.loc 1 231 88 discriminator 4
	mv	s1,a5
	.loc 1 231 115 discriminator 4
	lw	a5,-40(s0)
	addi	a5,a5,8
	.loc 1 231 106 discriminator 4
	lw	a5,0(a5)
	mv	a0,a5
	call	atoi
	mv	a5,a0
	.loc 1 231 21 discriminator 4
	lw	a3,-32(s0)
	mv	a2,a5
	mv	a1,s1
	lla	a0,.LC7
...
.L48:
	...
	lw	a5,-28(s0)
	bnez	a5,.L53
	.loc 1 255 60 is_stmt 0 discriminator 1
	lla	a5,.LC2
	j	.L54
.L53:
	.loc 1 255 60 discriminator 2
	lla	a5,.LC1
.L54:
	.loc 1 255 32 is_stmt 1 discriminator 4
	sw	a5,-32(s0)
	.loc 1 256 73 discriminator 4
	lla	a5,adc_device.4029
	lw	a5,0(a5)
	.loc 1 256 88 discriminator 4
	mv	s1,a5
	.loc 1 256 115 discriminator 4
	lw	a5,-40(s0)
	addi	a5,a5,8
	.loc 1 256 106 discriminator 4
	lw	a5,0(a5)
	mv	a0,a5
	call	atoi
	mv	a5,a0
	.loc 1 256 21 discriminator 4
	lw	a3,-32(s0)
	mv	a2,a5
	mv	a1,s1
	lla	a0,.LC13
...
.L51:
	...
	lw	a5,-28(s0)
	bnez	a5,.L58
	.loc 1 268 60 is_stmt 0 discriminator 1
	lla	a5,.LC2
	j	.L59
.L58:
	.loc 1 268 60 discriminator 2
	lla	a5,.LC1
.L59:
	.loc 1 268 32 is_stmt 1 discriminator 4
	sw	a5,-32(s0)
	.loc 1 269 82 discriminator 4
	lla	a5,adc_device.4029
	lw	a5,0(a5)
	.loc 1 269 97 discriminator 4
	mv	s1,a5
	.loc 1 269 124 discriminator 4
	lw	a5,-40(s0)
	addi	a5,a5,8
	.loc 1 269 115 discriminator 4
	lw	a5,0(a5)
	mv	a0,a5
	call	atoi
	mv	a2,a0
	.loc 1 269 21 discriminator 4
	lh	a4,-22(s0)
	li	a5,1000
	div	a5,a4,a5
	slli	a5,a5,16
...
.LFE28:
	.size	adc, .-adc
	.globl	__fsym_adc_name
	.section	.rodata.name,"a"
	.align	2
	.type	__fsym_adc_name, @object
	.size	__fsym_adc_name, 4
__fsym_adc_name:
	.string	"adc"
	.globl	__fsym_adc_desc
	.align	2
	.type	__fsym_adc_desc, @object
	.size	__fsym_adc_desc, 13
__fsym_adc_desc:
	.string	"adc [option]"
	.globl	__fsym_adc
	.section	FSymTab,"a"
	.align	2
	.type	__fsym_adc, @object
	.size	__fsym_adc, 12
__fsym_adc:
	.word	__fsym_adc_name
	.word	__fsym_adc_desc
	.word	adc
	.local	adc_device.4029
	.comm	adc_device.4029,4,4
	.text
.Letext0:
	...
	.file 11 "../../../../../../components/drivers/include/drivers/adc.h"
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0x4
	.file 53 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\stdlib.h"
	.byte	0x3
	.byte	0x11
	.byte	0x35
	.byte	0x5
	...
	.4byte	.Ldebug_macro31
	.byte	0x4
	.file 54 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\machine\\stdlib.h"
	.byte	0x3
	.byte	0x14
	.byte	0x36
	.byte	0x5
	...
	.4byte	.LASF1265
	.byte	0x4
	.file 55 "d:\\workers\\riscv-none-embed-gcc\\riscv-none-embed\\include\\alloca.h"
	.byte	0x3
	.byte	0x16
	.byte	0x37
	.byte	0x7
...
.LASF1509:
	.string	"RT_ADC_CMD_GET_RESOLUTION"
.LASF1065:
...
.LASF1535:
	.string	"../../../../../../components/drivers/misc/adc.c"
.LASF863:
