...
.LFE4:
	...
	.local	rt_scheduler_lock_nest
	.comm	rt_scheduler_lock_nest,2,2
...
rt_current_thread:
	...
	.local	rt_scheduler_hook
	.comm	rt_scheduler_hook,4,4
	.local	rt_scheduler_switch_hook
	.comm	rt_scheduler_switch_hook,4,4
	.text
	.align	1
...
.LFB16:
	...
	sw	a0,-20(s0)
	.loc 2 85 30
	lla	a5,rt_scheduler_switch_hook
	lw	a4,-20(s0)
	sw	a4,0(a5)
	.loc 2 86 1
	nop
...
.L19:
	...
	.loc 2 250 25
	bne	a4,a5,.L21
	.loc 2 250 109 discriminator 1
	lla	a5,rt_current_thread
	lw	a5,0(a5)
	lbu	a5,52(a5)
	.loc 2 250 116 discriminator 1
	andi	a5,a5,8
	.loc 2 250 88 discriminator 1
	bnez	a5,.L21
	.loc 2 252 31
	lla	a5,rt_current_thread
	lw	a5,0(a5)
