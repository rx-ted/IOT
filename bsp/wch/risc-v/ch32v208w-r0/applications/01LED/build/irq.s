...
.Ltext0:
	...
	.local	rt_interrupt_enter_hook
	.comm	rt_interrupt_enter_hook,4,4
	.local	rt_interrupt_leave_hook
	.comm	rt_interrupt_leave_hook,4,4
	.align	1
...
.LFB15:
	...
	sw	a0,-20(s0)
	.loc 1 43 29
	lla	a5,rt_interrupt_enter_hook
	lw	a4,-20(s0)
	sw	a4,0(a5)
	.loc 1 44 1
	nop
...
.LFB16:
	...
	sw	a0,-20(s0)
	.loc 1 57 29
	lla	a5,rt_interrupt_leave_hook
	lw	a4,-20(s0)
	sw	a4,0(a5)
	.loc 1 58 1
	nop
...
.LASF1064:
	.string	"__on_rt_interrupt_enter_hook() __ON_HOOK_ARGS(rt_interrupt_enter_hook, ())"
.LASF825:
...
.LASF1065:
	.string	"__on_rt_interrupt_leave_hook() __ON_HOOK_ARGS(rt_interrupt_leave_hook, ())"
.LASF1097:
