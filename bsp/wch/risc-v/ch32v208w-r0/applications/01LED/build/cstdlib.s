...
.Ltext0:
	...
	.align	1
	.globl	__rt_libc_exit
	.type	__rt_libc_exit, @function
__rt_libc_exit:
.LFB15:
	.file 1 "../../../../../../components/libc/compilers/common/cstdlib.c"
	.loc 1 18 1
	.cfi_startproc
	addi	sp,sp,-48
...
.L3:
	...
	.cfi_endproc
.LFE15:
	.size	__rt_libc_exit, .-__rt_libc_exit
	.align	1
	.globl	system
...
.L11:
	...
	li	a5,10
	bne	a4,a5,.L12
	.loc 1 72 25 is_stmt 0 discriminator 1
	lw	a5,-84(s0)
	bgez	a5,.L12
	.loc 1 72 25 discriminator 3
	li	a5,1
	j	.L13
.L12:
	.loc 1 72 25 discriminator 4
	li	a5,0
.L13:
	.loc 1 72 10 is_stmt 1 discriminator 6
	sw	a5,-32(s0)
	.loc 1 73 8 discriminator 6
	lw	a5,-32(s0)
	beqz	a5,.L14
	.loc 1 75 13
	lw	a5,-84(s0)
...
.LASF1120:
	.string	"rt_thread_t"
.LASF1143:
	.string	"../../../../../../components/libc/compilers/common/cstdlib.c"
.LASF261:
